...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f48ix = readShort();
        this.header.currentFrame.f49iy = readShort();
        this.header.currentFrame.f47iw = readShort();
        this.header.currentFrame.f46ih = readShort();
        int read = read();
        boolean z = false;
    ...
    private int[] readColorTable(int i) {
        ...
        try {
            ...
            while (i2 < i) {
                ...
                int i6 = i5 + 1;
                int i7 = i2 + 1;
                iArr[i2] = ((bArr[i3] & UnsignedBytes.MAX_VALUE) << Ascii.DLE) | Ascii.NUL | ((bArr[i4] & UnsignedBytes.MAX_VALUE) << 8) | (bArr[i5] & UnsignedBytes.MAX_VALUE);
                i3 = i6;
                i2 = i7;
            }
