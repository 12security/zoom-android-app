...
public class RequestOptions implements Cloneable {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions sizeMultiplierOf(@FloatRange(from = 0.0d, mo581to = 1.0d) float f) {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions encodeQualityOf(@IntRange(from = 0, mo587to = 100) int i) {
        return new RequestOptions().encodeQuality(i);
    }

    @CheckResult
    @NonNull
    public static RequestOptions encodeFormatOf(@NonNull CompressFormat compressFormat) {
    ...
    @CheckResult
    @NonNull
    public RequestOptions sizeMultiplier(@FloatRange(from = 0.0d, mo581to = 1.0d) float f) {
    ...
    @CheckResult
    @NonNull
    public RequestOptions encodeFormat(@NonNull CompressFormat compressFormat) {
        return set(BitmapEncoder.COMPRESSION_FORMAT, Preconditions.checkNotNull(compressFormat));
    }

    @CheckResult
    @NonNull
    public RequestOptions encodeQuality(@IntRange(from = 0, mo587to = 100) int i) {
