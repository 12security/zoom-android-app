...
public class RequestManager implements LifecycleListener, ModelTypes<RequestBuilder<Drawable>> {
    ...
    public RequestBuilder<Bitmap> asBitmap() {
        return mo9278as(Bitmap.class).apply(DECODE_TYPE_BITMAP);
    }

    @CheckResult
    @NonNull
    public RequestBuilder<GifDrawable> asGif() {
        return mo9278as(GifDrawable.class).apply(DECODE_TYPE_GIF);
    }

    @CheckResult
    @NonNull
    public RequestBuilder<Drawable> asDrawable() {
        return mo9278as(Drawable.class);
    }
    ...
    public RequestBuilder<File> downloadOnly() {
        return mo9278as(File.class).apply(DOWNLOAD_ONLY_OPTIONS);
    }
    ...
    public RequestBuilder<File> asFile() {
        return mo9278as(File.class).apply(RequestOptions.skipMemoryCacheOf(true));
    }

    @CheckResult
    @NonNull
    /* renamed from: as */
    public <ResourceType> RequestBuilder<ResourceType> mo9278as(@NonNull Class<ResourceType> cls) {
