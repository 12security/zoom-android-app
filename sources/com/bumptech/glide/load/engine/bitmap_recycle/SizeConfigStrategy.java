...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    static /* synthetic */ class C04951 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.engine.bitmap_recycle.SizeConfigStrategy.C04951.<clinit>():void");
        }
    }
    ...
    private static Config[] getInConfigs(Config config) {
        ...
        switch (C04951.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()]) {
            case 1:
