...
class ResourceCacheGenerator implements DataFetcherGenerator, DataCallback<Object> {
    ...
    ResourceCacheGenerator(DecodeHelper<?> decodeHelper, FetcherReadyCallback fetcherReadyCallback) {
        ...
        this.f53cb = fetcherReadyCallback;
    }
    ...
    public void onDataReady(Object obj) {
        this.f53cb.onDataFetcherReady(this.sourceKey, obj, this.loadData.fetcher, DataSource.RESOURCE_DISK_CACHE, this.currentKey);
    }

    public void onLoadFailed(@NonNull Exception exc) {
        this.f53cb.onDataFetcherFailed(this.currentKey, exc, this.loadData.fetcher, DataSource.RESOURCE_DISK_CACHE);
    }
}
