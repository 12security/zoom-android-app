...
class DataCacheGenerator implements DataFetcherGenerator, DataCallback<Object> {
    ...
    /* renamed from: cb */
    private final FetcherReadyCallback f51cb;
    ...
    DataCacheGenerator(List<Key> list, DecodeHelper<?> decodeHelper, FetcherReadyCallback fetcherReadyCallback) {
        ...
        this.f51cb = fetcherReadyCallback;
    }
    ...
    public void onDataReady(Object obj) {
        this.f51cb.onDataFetcherReady(this.sourceKey, obj, this.loadData.fetcher, DataSource.DATA_DISK_CACHE, this.sourceKey);
    }

    public void onLoadFailed(@NonNull Exception exc) {
        this.f51cb.onDataFetcherFailed(this.sourceKey, exc, this.loadData.fetcher, DataSource.DATA_DISK_CACHE);
    }
}
