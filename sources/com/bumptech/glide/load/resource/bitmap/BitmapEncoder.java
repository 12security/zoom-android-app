...
public class BitmapEncoder implements ResourceEncoder<Bitmap> {
    ...
    public boolean encode(@androidx.annotation.NonNull com.bumptech.glide.load.engine.Resource<android.graphics.Bitmap> r8, @androidx.annotation.NonNull java.io.File r9, @androidx.annotation.NonNull com.bumptech.glide.load.Options r10) {
        /*
            ...
            com.bumptech.glide.load.Option<java.lang.Integer> r3 = COMPRESSION_QUALITY     // Catch:{ all -> 0x00c6 }
            ...
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r9 = r7.arrayPool     // Catch:{ IOException -> 0x0052, all -> 0x004f }
            ...
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r5 = r7.arrayPool     // Catch:{ IOException -> 0x0052, all -> 0x004f }
        ...
        L_0x006b:
            ...
            r3.append(r0)     // Catch:{ all -> 0x00c6 }
            com.bumptech.glide.load.Option<android.graphics.Bitmap$CompressFormat> r0 = COMPRESSION_FORMAT     // Catch:{ all -> 0x00c6 }
