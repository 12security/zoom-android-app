...
public final class GlideOptions extends RequestOptions implements Cloneable {
    ...
    @CheckResult
    @NonNull
    public static GlideOptions sizeMultiplierOf(@FloatRange(from = 0.0d, mo581to = 1.0d) float f) {
    ...
    @CheckResult
    @NonNull
    public static GlideOptions encodeQualityOf(@IntRange(from = 0, mo587to = 100) int i) {
    ...
    @CheckResult
    @NonNull
    public final GlideOptions sizeMultiplier(@FloatRange(from = 0.0d, mo581to = 1.0d) float f) {
    ...
    @CheckResult
    @NonNull
    public final GlideOptions encodeQuality(@IntRange(from = 0, mo587to = 100) int i) {
