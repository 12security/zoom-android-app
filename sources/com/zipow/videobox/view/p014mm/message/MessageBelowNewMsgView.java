...
/* renamed from: com.zipow.videobox.view.mm.message.MessageBelowNewMsgView */
public class MessageBelowNewMsgView extends AbsMessageView {
    ...
    public MessageBelowNewMsgView(Context context) {
        super(context);
        initView();
    }
    ...
    public void inflateLayout() {
        View.inflate(getContext(), C4558R.layout.zm_message_below_new_msg, this);
    }
