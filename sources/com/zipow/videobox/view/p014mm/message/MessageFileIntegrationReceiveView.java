...
/* renamed from: com.zipow.videobox.view.mm.message.MessageFileIntegrationReceiveView */
public class MessageFileIntegrationReceiveView extends MessageFileIntegrationView {
    ...
    public Drawable getMesageBackgroudDrawable() {
        if (this.mMessageItem == null || !this.mMessageItem.hideStarView || this.mMessageItem.messageType != 11) {
