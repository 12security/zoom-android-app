...
/* renamed from: com.zipow.videobox.view.mm.message.MessageAudioReceiveView */
public class MessageAudioReceiveView extends MessageAudioView {
    public static String TAG = "MessageAudioReceiveView";
    ...
    public void setMessageItem(@NonNull MMMessageItem mMMessageItem) {
        ...
        if (!mMMessageItem.isPlayed) {
            setStatusImage(true, C4558R.C4559drawable.zm_ic_red_dot);
        } else {
    ...
    public void setStarredMessage(@NonNull MMMessageItem mMMessageItem) {
        if (mMMessageItem.hideStarView) {
            this.mPanelMessage.setFocusable(false);
    ...
    public Drawable getMesageBackgroudDrawable() {
        if (this.mMessageItem == null || !this.mMessageItem.hideStarView || this.mMessageItem.messageType != 3) {
