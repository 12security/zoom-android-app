...
/* renamed from: com.zipow.videobox.view.mm.message.MessageRemoveHistoryView */
public class MessageRemoveHistoryView extends AbsMessageView {
    Context context;
    private TextView mTxtMessage;
    private ImageView timeChatPop;

    /* renamed from: com.zipow.videobox.view.mm.message.MessageRemoveHistoryView$TimedChatFragment */
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ZMAlertDialog create = new Builder(getActivity()).setMessage(C4558R.string.zm_mm_msg_timed_chat3_33479).setPositiveButton(C4558R.string.zm_mm_msg_timed_chat_ok_33479, (OnClickListener) new OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    if (activity != null) {
                        activity.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(TimedChatFragment.this.getString(C4558R.string.zm_zoom_learn_more))));
                    }
                }
            }).create();
    ...
    public MessageRemoveHistoryView(Context context2, AttributeSet attributeSet) {
    ...
    public MessageRemoveHistoryView(Context context2) {
        this(context2, null);
    }

    private void initView() {
        View.inflate(getContext(), C4558R.layout.zm_message_remove_history, this);
