...
/* renamed from: com.zipow.videobox.view.mm.message.MessageThreadDeletedView */
public class MessageThreadDeletedView extends AbsMessageView {
    ...
    public void initView() {
        ...
        this.mPanelMessage.setOnLongClickListener(new OnLongClickListener() {
            public boolean onLongClick(View view) {
                ...
                OnShowContextMenuListener onShowContextMenuListener = MessageThreadDeletedView.this.getOnShowContextMenuListener();
                MessageThreadDeletedView messageThreadDeletedView = MessageThreadDeletedView.this;
                return onShowContextMenuListener.onShowContextMenu(messageThreadDeletedView, messageThreadDeletedView.mMessageItem);
            }
        });
    }
    ...
    public void setMessageItem(MMMessageItem mMMessageItem, boolean z) {
        if (mMMessageItem != null) {
            ...
            paramsBuilder.setResource(C4558R.C4559drawable.zm_avatar_thread_deleted, null);
            this.mAvatarView.show(paramsBuilder);
            this.mTxtMessage.setText(C4558R.string.zm_lbl_thread_deleted_88133);
