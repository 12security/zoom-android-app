...
public class ContactRequestsFragment extends ZMDialogFragment implements OnClickListener {
    ...
    public static void showAsActivity(@NonNull ZMActivity zMActivity, int i) {
        ...
        SimpleActivity.show(zMActivity, ContactRequestsFragment.class.getName(), bundle, i, true, 1);
    }

    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        View inflate = layoutInflater.inflate(C4558R.layout.zm_contact_requests, viewGroup, false);
        ...
        if (this.mZoomMessengerUIListener == null) {
            this.mZoomMessengerUIListener = new SimpleZoomMessengerUIListener() {
                ...
                public void onIndicateInfoUpdatedWithJID(String str) {
                    ContactRequestsFragment.this.onIndicateInfoUpdatedWithJID(str);
                }
                ...
                public void onNotifySubscribeRequestUpdated(String str) {
                    ContactRequestsFragment.this.onNotifySubscribeRequestUpdated(str);
                }
            };
        }
