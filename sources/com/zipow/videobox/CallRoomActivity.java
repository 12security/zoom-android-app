...
public class CallRoomActivity extends ZMActivity {
    ...
    public static void showJoinByNumber(@Nullable Context context, String str, String str2) {
        if (context != null) {
            Intent intent = new Intent(context, CallRoomActivity.class);
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        if (bundle == null) {
            ...
            getSupportFragmentManager().beginTransaction().add(16908290, callRoomFragment, CallRoomFragment.class.getName()).commit();
        }
    }
