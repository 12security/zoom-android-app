...
public class UTF8JsonGenerator extends JsonGeneratorImpl {
    ...
    public final int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr, int i) throws IOException, JsonGenerationException {
        ...
        while (true) {
            ...
            i4 = i8 + 1;
            i -= 3;
            this._outputTail = base64Variant.encodeBase64Chunk((int) (((bArr[i6] & UnsignedBytes.MAX_VALUE) | i7) << 8) | (bArr[i8] & UnsignedBytes.MAX_VALUE), this._outputBuffer, this._outputTail);
            maxLineLength--;
            if (maxLineLength <= 0) {
                byte[] bArr2 = this._outputBuffer;
                int i9 = this._outputTail;
    ...
    private final int _outputRawMultiByteChar(int i, char[] cArr, int i2, int i3) throws IOException {
        if (i < 55296 || i > 57343) {
            ...
            int i4 = this._outputTail;
            this._outputTail = i4 + 1;
            bArr[i4] = (byte) ((i >> 12) | DummyPolicyIDType.zPolicy_SetShortCuts_JumpToSession);
    ...
    public final void _outputSurrogates(int i, int i2) throws IOException {
        ...
        int i3 = this._outputTail;
        this._outputTail = i3 + 1;
        bArr[i3] = (byte) ((_decodeSurrogate >> 18) | DummyPolicyIDType.zPolicy_EnableElevateForAdvDSCP);
        int i4 = this._outputTail;
        this._outputTail = i4 + 1;
    ...
    private final int _outputMultiByteChar(int i, int i2) throws IOException {
        ...
        if (i < 55296 || i > 57343) {
            int i3 = i2 + 1;
            bArr[i2] = (byte) ((i >> 12) | DummyPolicyIDType.zPolicy_SetShortCuts_JumpToSession);
            int i4 = i3 + 1;
