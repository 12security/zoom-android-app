...
public final class JsonStringEncoder {
    ...
    /* renamed from: HB */
    private static final byte[] f170HB = CharTypes.copyHexBytes();

    /* renamed from: HC */
    private static final char[] f171HC = CharTypes.copyHexChars();
    ...
    public char[] quoteAsString(java.lang.String r12) {
        ...
        L_0x000c:
            ...
            int[] r2 = com.fasterxml.jackson.core.p006io.CharTypes.get7BitOutputEscapes()
            int r3 = r2.length
            int r4 = r12.length()
            r5 = 0
            r6 = r1
    ...
    public void quoteAsString(java.lang.CharSequence r8, java.lang.StringBuilder r9) {
        /*
            r7 = this;
            int[] r0 = com.fasterxml.jackson.core.p006io.CharTypes.get7BitOutputEscapes()
            int r1 = r0.length
            int r2 = r8.length()
            r3 = 0
            r4 = 0
        ...
        L_0x003c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.p006io.JsonStringEncoder.quoteAsString(java.lang.CharSequence, java.lang.StringBuilder):void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x009b, code lost:
        r7 = r5 + 1;
        r4[r5] = (byte) ((r2 >> 18) | com.zipow.videobox.ptapp.DummyPolicyIDType.zPolicy_EnableElevateForAdvDSCP);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:45:0x00d1, code lost:
        r6 = r5 + 1;
        r4[r5] = (byte) ((r2 >> 12) | com.zipow.videobox.ptapp.DummyPolicyIDType.zPolicy_SetShortCuts_JumpToSession);
     */
    ...
    public byte[] quoteAsUTF8(java.lang.String r11) {
        ...
        L_0x0018:
            ...
            int[] r6 = com.fasterxml.jackson.core.p006io.CharTypes.get7BitOutputEscapes()
        L_0x001e:
    ...
    public byte[] encodeAsUTF8(String str) {
        ...
        while (true) {
            ...
            if (charAt < 2048) {
                ...
                int i8 = i3 + 1;
                bArr[i3] = (byte) ((charAt >> 12) | DummyPolicyIDType.zPolicy_SetShortCuts_JumpToSession);
                if (i8 >= length2) {
                    bArr = byteArrayBuilder.finishCurrentSegment();
                    length2 = bArr.length;
                    i8 = 0;
                ...
                int i10 = i3 + 1;
                bArr[i3] = (byte) ((charAt >> 18) | DummyPolicyIDType.zPolicy_EnableElevateForAdvDSCP);
                if (i10 >= length2) {
                    bArr = byteArrayBuilder.finishCurrentSegment();
                    length2 = bArr.length;
                    i10 = 0;
    ...
    private int _appendByte(int i, int i2, ByteArrayBuilder byteArrayBuilder, int i3) {
        ...
        if (i2 < 0) {
            ...
            if (i > 255) {
                int i4 = i >> 8;
                byteArrayBuilder.append(f170HB[i4 >> 4]);
                byteArrayBuilder.append(f170HB[i4 & 15]);
                i &= 255;
            } else {
                byteArrayBuilder.append(48);
                byteArrayBuilder.append(48);
            }
            byteArrayBuilder.append(f170HB[i >> 4]);
            byteArrayBuilder.append(f170HB[i & 15]);
        } else {
