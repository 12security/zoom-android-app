...
/* renamed from: com.dropbox.core.v2.users.IndividualSpaceAllocation */
public class IndividualSpaceAllocation {
    protected final long allocated;

    /* renamed from: com.dropbox.core.v2.users.IndividualSpaceAllocation$Serializer */
    static class Serializer extends StructSerializer<IndividualSpaceAllocation> {
        ...
        public void serialize(IndividualSpaceAllocation individualSpaceAllocation, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            ...
            StoneSerializers.uInt64().serialize(Long.valueOf(individualSpaceAllocation.allocated), jsonGenerator);
            if (!z) {
