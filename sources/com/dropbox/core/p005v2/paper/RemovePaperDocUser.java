...
/* renamed from: com.dropbox.core.v2.paper.RemovePaperDocUser */
class RemovePaperDocUser extends RefPaperDoc {
    protected final MemberSelector member;

    /* renamed from: com.dropbox.core.v2.paper.RemovePaperDocUser$Serializer */
    static class Serializer extends StructSerializer<RemovePaperDocUser> {
        ...
        public void serialize(RemovePaperDocUser removePaperDocUser, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            if (!z) {
                jsonGenerator.writeStartObject();
            }
            jsonGenerator.writeFieldName("doc_id");
            StoneSerializers.string().serialize(removePaperDocUser.docId, jsonGenerator);
            jsonGenerator.writeFieldName("member");
            com.dropbox.core.p005v2.sharing.MemberSelector.Serializer.INSTANCE.serialize(removePaperDocUser.member, jsonGenerator);
            if (!z) {
                jsonGenerator.writeEndObject();
            }
        }

        public RemovePaperDocUser deserialize(JsonParser jsonParser, boolean z) throws IOException, JsonParseException {
            String str;
            String str2 = null;
            if (!z) {
            ...
            if (str == null) {
                ...
                if (str2 == null) {
                    ...
                    StoneDeserializerLogger.log(removePaperDocUser, removePaperDocUser.toStringMultiline());
    ...
    public boolean equals(java.lang.Object r5) {
        ...
        L_0x0008:
            ...
            com.dropbox.core.v2.paper.RemovePaperDocUser r5 = (com.dropbox.core.p005v2.paper.RemovePaperDocUser) r5
        ...
        L_0x0037:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dropbox.core.p005v2.paper.RemovePaperDocUser.equals(java.lang.Object):boolean");
    }
