...
/* renamed from: com.dropbox.core.v2.team.ListTeamDevicesArg */
class ListTeamDevicesArg {
    ...
    /* renamed from: com.dropbox.core.v2.team.ListTeamDevicesArg$Builder */
    ...
    /* renamed from: com.dropbox.core.v2.team.ListTeamDevicesArg$Serializer */
    static class Serializer extends StructSerializer<ListTeamDevicesArg> {
        ...
        public void serialize(ListTeamDevicesArg listTeamDevicesArg, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            if (!z) {
                jsonGenerator.writeStartObject();
            }
            if (listTeamDevicesArg.cursor != null) {
                jsonGenerator.writeFieldName("cursor");
                StoneSerializers.nullable(StoneSerializers.string()).serialize(listTeamDevicesArg.cursor, jsonGenerator);
            }
            jsonGenerator.writeFieldName("include_web_sessions");
            StoneSerializers.boolean_().serialize(Boolean.valueOf(listTeamDevicesArg.includeWebSessions), jsonGenerator);
            jsonGenerator.writeFieldName("include_desktop_clients");
            StoneSerializers.boolean_().serialize(Boolean.valueOf(listTeamDevicesArg.includeDesktopClients), jsonGenerator);
            jsonGenerator.writeFieldName("include_mobile_clients");
            StoneSerializers.boolean_().serialize(Boolean.valueOf(listTeamDevicesArg.includeMobileClients), jsonGenerator);
            if (!z) {
                jsonGenerator.writeEndObject();
            }
        }

        public ListTeamDevicesArg deserialize(JsonParser jsonParser, boolean z) throws IOException, JsonParseException {
            String str;
            String str2 = null;
            if (!z) {
            ...
            if (str == null) {
                ...
                ListTeamDevicesArg listTeamDevicesArg = new ListTeamDevicesArg(str2, valueOf.booleanValue(), valueOf2.booleanValue(), valueOf3.booleanValue());
                if (!z) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!((str == str2 || (str != null && str.equals(str2))) && this.includeWebSessions == listTeamDevicesArg.includeWebSessions && this.includeDesktopClients == listTeamDevicesArg.includeDesktopClients && this.includeMobileClients == listTeamDevicesArg.includeMobileClients)) {
            z = false;
        }
        return z;
    }
