...
/* renamed from: com.dropbox.core.v2.team.ListTeamDevicesResult */
public class ListTeamDevicesResult {
    protected final String cursor;
    protected final List<MemberDevices> devices;
    protected final boolean hasMore;

    /* renamed from: com.dropbox.core.v2.team.ListTeamDevicesResult$Serializer */
    static class Serializer extends StructSerializer<ListTeamDevicesResult> {
        ...
        public void serialize(ListTeamDevicesResult listTeamDevicesResult, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            if (!z) {
                jsonGenerator.writeStartObject();
            }
            jsonGenerator.writeFieldName(KubiContract.EXTRA_DEVICES);
            StoneSerializers.list(Serializer.INSTANCE).serialize(listTeamDevicesResult.devices, jsonGenerator);
            jsonGenerator.writeFieldName("has_more");
            StoneSerializers.boolean_().serialize(Boolean.valueOf(listTeamDevicesResult.hasMore), jsonGenerator);
            if (listTeamDevicesResult.cursor != null) {
                jsonGenerator.writeFieldName("cursor");
                StoneSerializers.nullable(StoneSerializers.string()).serialize(listTeamDevicesResult.cursor, jsonGenerator);
            }
            if (!z) {
        ...
        public ListTeamDevicesResult deserialize(JsonParser jsonParser, boolean z) throws IOException, JsonParseException {
            String str;
            List list = null;
            if (!z) {
    ...
    public boolean equals(java.lang.Object r5) {
        ...
        L_0x0008:
            ...
            com.dropbox.core.v2.team.ListTeamDevicesResult r5 = (com.dropbox.core.p005v2.team.ListTeamDevicesResult) r5
        ...
        L_0x003b:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dropbox.core.p005v2.team.ListTeamDevicesResult.equals(java.lang.Object):boolean");
    }
