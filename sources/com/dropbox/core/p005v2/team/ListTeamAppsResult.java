...
/* renamed from: com.dropbox.core.v2.team.ListTeamAppsResult */
public class ListTeamAppsResult {
    protected final List<MemberLinkedApps> apps;
    protected final String cursor;
    protected final boolean hasMore;

    /* renamed from: com.dropbox.core.v2.team.ListTeamAppsResult$Serializer */
    static class Serializer extends StructSerializer<ListTeamAppsResult> {
        ...
        public void serialize(ListTeamAppsResult listTeamAppsResult, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            if (!z) {
                jsonGenerator.writeStartObject();
            }
            jsonGenerator.writeFieldName("apps");
            StoneSerializers.list(Serializer.INSTANCE).serialize(listTeamAppsResult.apps, jsonGenerator);
            jsonGenerator.writeFieldName("has_more");
            StoneSerializers.boolean_().serialize(Boolean.valueOf(listTeamAppsResult.hasMore), jsonGenerator);
            if (listTeamAppsResult.cursor != null) {
                jsonGenerator.writeFieldName("cursor");
                StoneSerializers.nullable(StoneSerializers.string()).serialize(listTeamAppsResult.cursor, jsonGenerator);
            }
            if (!z) {
        ...
        public ListTeamAppsResult deserialize(JsonParser jsonParser, boolean z) throws IOException, JsonParseException {
            String str;
            List list = null;
            if (!z) {
    ...
    public boolean equals(java.lang.Object r5) {
        ...
        L_0x0008:
            ...
            com.dropbox.core.v2.team.ListTeamAppsResult r5 = (com.dropbox.core.p005v2.team.ListTeamAppsResult) r5
        ...
        L_0x003b:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dropbox.core.p005v2.team.ListTeamAppsResult.equals(java.lang.Object):boolean");
    }
