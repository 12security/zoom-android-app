...
/* renamed from: com.dropbox.core.v2.files.Dimensions */
public class Dimensions {
    protected final long height;
    protected final long width;

    /* renamed from: com.dropbox.core.v2.files.Dimensions$Serializer */
    static class Serializer extends StructSerializer<Dimensions> {
        ...
        public void serialize(Dimensions dimensions, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            if (!z) {
                jsonGenerator.writeStartObject();
            }
            jsonGenerator.writeFieldName("height");
            StoneSerializers.uInt64().serialize(Long.valueOf(dimensions.height), jsonGenerator);
            jsonGenerator.writeFieldName("width");
            StoneSerializers.uInt64().serialize(Long.valueOf(dimensions.width), jsonGenerator);
            if (!z) {
                jsonGenerator.writeEndObject();
            }
        }

        public Dimensions deserialize(JsonParser jsonParser, boolean z) throws IOException, JsonParseException {
            String str;
            Long l = null;
            if (!z) {
