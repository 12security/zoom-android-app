...
/* renamed from: com.dropbox.core.v2.teamlog.SfFbInviteChangeRoleDetails */
public class SfFbInviteChangeRoleDetails {
    ...
    /* renamed from: com.dropbox.core.v2.teamlog.SfFbInviteChangeRoleDetails$Builder */
    public static class Builder {
        ...
        public SfFbInviteChangeRoleDetails build() {
            SfFbInviteChangeRoleDetails sfFbInviteChangeRoleDetails = new SfFbInviteChangeRoleDetails(this.targetAssetIndex, this.originalFolderName, this.previousSharingPermission, this.newSharingPermission);
            return sfFbInviteChangeRoleDetails;
        }
    }

    /* renamed from: com.dropbox.core.v2.teamlog.SfFbInviteChangeRoleDetails$Serializer */
    static class Serializer extends StructSerializer<SfFbInviteChangeRoleDetails> {
        ...
        public void serialize(SfFbInviteChangeRoleDetails sfFbInviteChangeRoleDetails, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            if (!z) {
                jsonGenerator.writeStartObject();
            }
            jsonGenerator.writeFieldName("target_asset_index");
            StoneSerializers.uInt64().serialize(Long.valueOf(sfFbInviteChangeRoleDetails.targetAssetIndex), jsonGenerator);
            jsonGenerator.writeFieldName("original_folder_name");
            StoneSerializers.string().serialize(sfFbInviteChangeRoleDetails.originalFolderName, jsonGenerator);
            if (sfFbInviteChangeRoleDetails.previousSharingPermission != null) {
                jsonGenerator.writeFieldName("previous_sharing_permission");
                StoneSerializers.nullable(StoneSerializers.string()).serialize(sfFbInviteChangeRoleDetails.previousSharingPermission, jsonGenerator);
            }
            if (sfFbInviteChangeRoleDetails.newSharingPermission != null) {
                jsonGenerator.writeFieldName("new_sharing_permission");
                StoneSerializers.nullable(StoneSerializers.string()).serialize(sfFbInviteChangeRoleDetails.newSharingPermission, jsonGenerator);
            }
            if (!z) {
        ...
        public SfFbInviteChangeRoleDetails deserialize(JsonParser jsonParser, boolean z) throws IOException, JsonParseException {
            String str;
            Long l = null;
            if (!z) {
    ...
    public SfFbInviteChangeRoleDetails(long j, String str, String str2, String str3) {
        this.targetAssetIndex = j;
        if (str != null) {
            this.originalFolderName = str;
    ...
    public SfFbInviteChangeRoleDetails(long j, String str) {
    ...
    public boolean equals(java.lang.Object r7) {
        ...
        L_0x0008:
            ...
            com.dropbox.core.v2.teamlog.SfFbInviteChangeRoleDetails r7 = (com.dropbox.core.p005v2.teamlog.SfFbInviteChangeRoleDetails) r7
        ...
        L_0x002c:
            ...
            java.lang.String r3 = r7.previousSharingPermission
        ...
        L_0x003a:
            ...
            java.lang.String r7 = r7.newSharingPermission
        ...
        L_0x004b:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dropbox.core.p005v2.teamlog.SfFbInviteChangeRoleDetails.equals(java.lang.Object):boolean");
    }
