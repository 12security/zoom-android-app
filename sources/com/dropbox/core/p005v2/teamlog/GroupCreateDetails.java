...
/* renamed from: com.dropbox.core.v2.teamlog.GroupCreateDetails */
public class GroupCreateDetails {
    protected final Boolean isCompanyManaged;
    protected final GroupJoinPolicy joinPolicy;

    /* renamed from: com.dropbox.core.v2.teamlog.GroupCreateDetails$Builder */
    ...
    /* renamed from: com.dropbox.core.v2.teamlog.GroupCreateDetails$Serializer */
    static class Serializer extends StructSerializer<GroupCreateDetails> {
        ...
        public void serialize(GroupCreateDetails groupCreateDetails, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            ...
            if (groupCreateDetails.isCompanyManaged != null) {
                ...
                StoneSerializers.nullable(StoneSerializers.boolean_()).serialize(groupCreateDetails.isCompanyManaged, jsonGenerator);
            }
            if (groupCreateDetails.joinPolicy != null) {
                jsonGenerator.writeFieldName("join_policy");
                StoneSerializers.nullable(Serializer.INSTANCE).serialize(groupCreateDetails.joinPolicy, jsonGenerator);
            }
            if (!z) {
    ...
    public boolean equals(java.lang.Object r5) {
        ...
        L_0x0008:
            ...
            com.dropbox.core.v2.teamlog.GroupCreateDetails r5 = (com.dropbox.core.p005v2.teamlog.GroupCreateDetails) r5
        ...
        L_0x0037:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dropbox.core.p005v2.teamlog.GroupCreateDetails.equals(java.lang.Object):boolean");
    }
