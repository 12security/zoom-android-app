...
/* renamed from: com.dropbox.core.v2.teamlog.SfExternalInviteWarnDetails */
public class SfExternalInviteWarnDetails {
    ...
    /* renamed from: com.dropbox.core.v2.teamlog.SfExternalInviteWarnDetails$Builder */
    public static class Builder {
        ...
        public SfExternalInviteWarnDetails build() {
            SfExternalInviteWarnDetails sfExternalInviteWarnDetails = new SfExternalInviteWarnDetails(this.targetAssetIndex, this.originalFolderName, this.newSharingPermission, this.previousSharingPermission);
            return sfExternalInviteWarnDetails;
        }
    }

    /* renamed from: com.dropbox.core.v2.teamlog.SfExternalInviteWarnDetails$Serializer */
    static class Serializer extends StructSerializer<SfExternalInviteWarnDetails> {
        ...
        public void serialize(SfExternalInviteWarnDetails sfExternalInviteWarnDetails, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            if (!z) {
                jsonGenerator.writeStartObject();
            }
            jsonGenerator.writeFieldName("target_asset_index");
            StoneSerializers.uInt64().serialize(Long.valueOf(sfExternalInviteWarnDetails.targetAssetIndex), jsonGenerator);
            jsonGenerator.writeFieldName("original_folder_name");
            StoneSerializers.string().serialize(sfExternalInviteWarnDetails.originalFolderName, jsonGenerator);
            if (sfExternalInviteWarnDetails.newSharingPermission != null) {
                jsonGenerator.writeFieldName("new_sharing_permission");
                StoneSerializers.nullable(StoneSerializers.string()).serialize(sfExternalInviteWarnDetails.newSharingPermission, jsonGenerator);
            }
            if (sfExternalInviteWarnDetails.previousSharingPermission != null) {
                jsonGenerator.writeFieldName("previous_sharing_permission");
                StoneSerializers.nullable(StoneSerializers.string()).serialize(sfExternalInviteWarnDetails.previousSharingPermission, jsonGenerator);
            }
            if (!z) {
        ...
        public SfExternalInviteWarnDetails deserialize(JsonParser jsonParser, boolean z) throws IOException, JsonParseException {
            String str;
            Long l = null;
            if (!z) {
            ...
            if (str == null) {
                ...
                if (l == null) {
                    ...
                    SfExternalInviteWarnDetails sfExternalInviteWarnDetails = new SfExternalInviteWarnDetails(l.longValue(), str2, str3, str4);
                    if (!z) {
                        expectEndObject(jsonParser);
                    }
                    StoneDeserializerLogger.log(sfExternalInviteWarnDetails, sfExternalInviteWarnDetails.toStringMultiline());
                    return sfExternalInviteWarnDetails;
                } else {
    ...
    public SfExternalInviteWarnDetails(long j, String str, String str2, String str3) {
        this.targetAssetIndex = j;
        if (str != null) {
            this.originalFolderName = str;
    ...
    public SfExternalInviteWarnDetails(long j, String str) {
    ...
    public boolean equals(java.lang.Object r7) {
        ...
        L_0x0008:
            ...
            com.dropbox.core.v2.teamlog.SfExternalInviteWarnDetails r7 = (com.dropbox.core.p005v2.teamlog.SfExternalInviteWarnDetails) r7
        ...
        L_0x004b:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dropbox.core.p005v2.teamlog.SfExternalInviteWarnDetails.equals(java.lang.Object):boolean");
    }
