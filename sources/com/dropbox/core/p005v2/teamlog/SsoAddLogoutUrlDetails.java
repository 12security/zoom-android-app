...
/* renamed from: com.dropbox.core.v2.teamlog.SsoAddLogoutUrlDetails */
public class SsoAddLogoutUrlDetails {
    protected final String newValue;

    /* renamed from: com.dropbox.core.v2.teamlog.SsoAddLogoutUrlDetails$Serializer */
    static class Serializer extends StructSerializer<SsoAddLogoutUrlDetails> {
        ...
        public void serialize(SsoAddLogoutUrlDetails ssoAddLogoutUrlDetails, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            if (!z) {
                jsonGenerator.writeStartObject();
            }
            if (ssoAddLogoutUrlDetails.newValue != null) {
                jsonGenerator.writeFieldName("new_value");
                StoneSerializers.nullable(StoneSerializers.string()).serialize(ssoAddLogoutUrlDetails.newValue, jsonGenerator);
            }
            if (!z) {
        ...
        public SsoAddLogoutUrlDetails deserialize(JsonParser jsonParser, boolean z) throws IOException, JsonParseException {
            String str;
            String str2 = null;
            if (!z) {
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = ssoAddLogoutUrlDetails.newValue;
