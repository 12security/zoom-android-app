...
/* renamed from: com.dropbox.core.v2.teamlog.SharedContentDownloadDetails */
public class SharedContentDownloadDetails {
    ...
    /* renamed from: com.dropbox.core.v2.teamlog.SharedContentDownloadDetails$Serializer */
    static class Serializer extends StructSerializer<SharedContentDownloadDetails> {
        public static final Serializer INSTANCE = new Serializer();

        Serializer() {
        }

        public void serialize(SharedContentDownloadDetails sharedContentDownloadDetails, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            if (!z) {
                jsonGenerator.writeStartObject();
            }
            jsonGenerator.writeFieldName("shared_content_link");
            StoneSerializers.string().serialize(sharedContentDownloadDetails.sharedContentLink, jsonGenerator);
            jsonGenerator.writeFieldName("shared_content_access_level");
            com.dropbox.core.p005v2.sharing.AccessLevel.Serializer.INSTANCE.serialize(sharedContentDownloadDetails.sharedContentAccessLevel, jsonGenerator);
            if (sharedContentDownloadDetails.sharedContentOwner != null) {
                jsonGenerator.writeFieldName("shared_content_owner");
                StoneSerializers.nullableStruct(Serializer.INSTANCE).serialize(sharedContentDownloadDetails.sharedContentOwner, jsonGenerator);
            }
            if (!z) {
        ...
        public SharedContentDownloadDetails deserialize(JsonParser jsonParser, boolean z) throws IOException, JsonParseException {
            String str;
            String str2 = null;
            if (!z) {
            ...
            if (str == null) {
                ...
                if (str2 == null) {
                    ...
                    SharedContentDownloadDetails sharedContentDownloadDetails = new SharedContentDownloadDetails(str2, accessLevel, userLogInfo);
                    if (!z) {
                        expectEndObject(jsonParser);
                    }
                    StoneDeserializerLogger.log(sharedContentDownloadDetails, sharedContentDownloadDetails.toStringMultiline());
    ...
    public SharedContentDownloadDetails(String str, AccessLevel accessLevel, UserLogInfo userLogInfo) {
        if (str != null) {
    ...
    public SharedContentDownloadDetails(String str, AccessLevel accessLevel) {
    ...
    public boolean equals(java.lang.Object r5) {
        ...
        L_0x0008:
            ...
            com.dropbox.core.v2.teamlog.SharedContentDownloadDetails r5 = (com.dropbox.core.p005v2.teamlog.SharedContentDownloadDetails) r5
        ...
        L_0x0041:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dropbox.core.p005v2.teamlog.SharedContentDownloadDetails.equals(java.lang.Object):boolean");
    }
