...
/* renamed from: com.dropbox.core.v2.teamlog.PaperDocChangeSubscriptionDetails */
public class PaperDocChangeSubscriptionDetails {
    ...
    /* renamed from: com.dropbox.core.v2.teamlog.PaperDocChangeSubscriptionDetails$Serializer */
    static class Serializer extends StructSerializer<PaperDocChangeSubscriptionDetails> {
        ...
        public void serialize(PaperDocChangeSubscriptionDetails paperDocChangeSubscriptionDetails, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            if (!z) {
                jsonGenerator.writeStartObject();
            }
            jsonGenerator.writeFieldName("event_uuid");
            StoneSerializers.string().serialize(paperDocChangeSubscriptionDetails.eventUuid, jsonGenerator);
            jsonGenerator.writeFieldName("new_subscription_level");
            StoneSerializers.string().serialize(paperDocChangeSubscriptionDetails.newSubscriptionLevel, jsonGenerator);
            if (paperDocChangeSubscriptionDetails.previousSubscriptionLevel != null) {
                ...
                StoneSerializers.nullable(StoneSerializers.string()).serialize(paperDocChangeSubscriptionDetails.previousSubscriptionLevel, jsonGenerator);
            }
            if (!z) {
        ...
        public PaperDocChangeSubscriptionDetails deserialize(JsonParser jsonParser, boolean z) throws IOException, JsonParseException {
            String str;
            String str2 = null;
            if (!z) {
    ...
    public boolean equals(java.lang.Object r5) {
        ...
        L_0x0008:
            ...
            com.dropbox.core.v2.teamlog.PaperDocChangeSubscriptionDetails r5 = (com.dropbox.core.p005v2.teamlog.PaperDocChangeSubscriptionDetails) r5
        ...
        L_0x0041:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dropbox.core.p005v2.teamlog.PaperDocChangeSubscriptionDetails.equals(java.lang.Object):boolean");
    }
