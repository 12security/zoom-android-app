...
/* renamed from: com.dropbox.core.v2.teamlog.SharedContentRemoveLinkPasswordDetails */
public class SharedContentRemoveLinkPasswordDetails {

    /* renamed from: com.dropbox.core.v2.teamlog.SharedContentRemoveLinkPasswordDetails$Serializer */
    static class Serializer extends StructSerializer<SharedContentRemoveLinkPasswordDetails> {
        ...
        public SharedContentRemoveLinkPasswordDetails deserialize(JsonParser jsonParser, boolean z) throws IOException, JsonParseException {
            ...
            if (str == null) {
                SharedContentRemoveLinkPasswordDetails sharedContentRemoveLinkPasswordDetails = new SharedContentRemoveLinkPasswordDetails();
                if (!z) {
                    expectEndObject(jsonParser);
                }
                StoneDeserializerLogger.log(sharedContentRemoveLinkPasswordDetails, sharedContentRemoveLinkPasswordDetails.toStringMultiline());
