...
/* renamed from: com.dropbox.core.v2.teamlog.SecondaryMailsPolicy */
public enum SecondaryMailsPolicy {
    DISABLED,
    ENABLED,
    OTHER;

    /* renamed from: com.dropbox.core.v2.teamlog.SecondaryMailsPolicy$Serializer */
    static class Serializer extends UnionSerializer<SecondaryMailsPolicy> {
        ...
        public SecondaryMailsPolicy deserialize(JsonParser jsonParser) throws IOException, JsonParseException {
            ...
            if (str != null) {
                if ("disabled".equals(str)) {
                    secondaryMailsPolicy = SecondaryMailsPolicy.DISABLED;
                } else if (AddrBookSettingActivity.ARG_RESULT_ENABLED.equals(str)) {
                    secondaryMailsPolicy = SecondaryMailsPolicy.ENABLED;
                } else {
                    secondaryMailsPolicy = SecondaryMailsPolicy.OTHER;
                }
                if (!z) {
