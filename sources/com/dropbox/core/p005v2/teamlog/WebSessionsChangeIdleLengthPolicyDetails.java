...
/* renamed from: com.dropbox.core.v2.teamlog.WebSessionsChangeIdleLengthPolicyDetails */
public class WebSessionsChangeIdleLengthPolicyDetails {
    ...
    /* renamed from: com.dropbox.core.v2.teamlog.WebSessionsChangeIdleLengthPolicyDetails$Builder */
    ...
    /* renamed from: com.dropbox.core.v2.teamlog.WebSessionsChangeIdleLengthPolicyDetails$Serializer */
    static class Serializer extends StructSerializer<WebSessionsChangeIdleLengthPolicyDetails> {
        ...
        public void serialize(WebSessionsChangeIdleLengthPolicyDetails webSessionsChangeIdleLengthPolicyDetails, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            ...
            if (webSessionsChangeIdleLengthPolicyDetails.newValue != null) {
                ...
                StoneSerializers.nullable(Serializer.INSTANCE).serialize(webSessionsChangeIdleLengthPolicyDetails.newValue, jsonGenerator);
            }
            if (webSessionsChangeIdleLengthPolicyDetails.previousValue != null) {
                jsonGenerator.writeFieldName("previous_value");
                StoneSerializers.nullable(Serializer.INSTANCE).serialize(webSessionsChangeIdleLengthPolicyDetails.previousValue, jsonGenerator);
            }
            if (!z) {
            ...
            if (str == null) {
                ...
                while (jsonParser.getCurrentToken() == JsonToken.FIELD_NAME) {
                    ...
                    if ("new_value".equals(currentName)) {
                        webSessionsIdleLengthPolicy = (WebSessionsIdleLengthPolicy) StoneSerializers.nullable(Serializer.INSTANCE).deserialize(jsonParser);
                    } else if ("previous_value".equals(currentName)) {
                        webSessionsIdleLengthPolicy2 = (WebSessionsIdleLengthPolicy) StoneSerializers.nullable(Serializer.INSTANCE).deserialize(jsonParser);
                    } else {
    ...
    public boolean equals(java.lang.Object r5) {
        ...
        L_0x0008:
            ...
            com.dropbox.core.v2.teamlog.WebSessionsChangeIdleLengthPolicyDetails r5 = (com.dropbox.core.p005v2.teamlog.WebSessionsChangeIdleLengthPolicyDetails) r5
            com.dropbox.core.v2.teamlog.WebSessionsIdleLengthPolicy r2 = r4.newValue
            com.dropbox.core.v2.teamlog.WebSessionsIdleLengthPolicy r3 = r5.newValue
            if (r2 == r3) goto L_0x0026
            if (r2 == 0) goto L_0x0035
            boolean r2 = r2.equals(r3)
            if (r2 == 0) goto L_0x0035
        L_0x0026:
            com.dropbox.core.v2.teamlog.WebSessionsIdleLengthPolicy r2 = r4.previousValue
            com.dropbox.core.v2.teamlog.WebSessionsIdleLengthPolicy r5 = r5.previousValue
        ...
        L_0x0037:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dropbox.core.p005v2.teamlog.WebSessionsChangeIdleLengthPolicyDetails.equals(java.lang.Object):boolean");
    }
