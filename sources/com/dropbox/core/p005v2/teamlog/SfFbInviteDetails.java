...
/* renamed from: com.dropbox.core.v2.teamlog.SfFbInviteDetails */
public class SfFbInviteDetails {
    protected final String originalFolderName;
    protected final String sharingPermission;
    protected final long targetAssetIndex;

    /* renamed from: com.dropbox.core.v2.teamlog.SfFbInviteDetails$Serializer */
    static class Serializer extends StructSerializer<SfFbInviteDetails> {
        ...
        public void serialize(SfFbInviteDetails sfFbInviteDetails, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            if (!z) {
                jsonGenerator.writeStartObject();
            }
            jsonGenerator.writeFieldName("target_asset_index");
            StoneSerializers.uInt64().serialize(Long.valueOf(sfFbInviteDetails.targetAssetIndex), jsonGenerator);
            jsonGenerator.writeFieldName("original_folder_name");
            StoneSerializers.string().serialize(sfFbInviteDetails.originalFolderName, jsonGenerator);
            if (sfFbInviteDetails.sharingPermission != null) {
                jsonGenerator.writeFieldName("sharing_permission");
                StoneSerializers.nullable(StoneSerializers.string()).serialize(sfFbInviteDetails.sharingPermission, jsonGenerator);
            }
            if (!z) {
        ...
        public SfFbInviteDetails deserialize(JsonParser jsonParser, boolean z) throws IOException, JsonParseException {
            String str;
            Long l = null;
            if (!z) {
            ...
            if (str == null) {
                ...
                if (l == null) {
                    ...
                    StoneDeserializerLogger.log(sfFbInviteDetails, sfFbInviteDetails.toStringMultiline());
    ...
    public boolean equals(java.lang.Object r7) {
        ...
        L_0x0008:
            ...
            com.dropbox.core.v2.teamlog.SfFbInviteDetails r7 = (com.dropbox.core.p005v2.teamlog.SfFbInviteDetails) r7
        ...
        L_0x003d:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dropbox.core.p005v2.teamlog.SfFbInviteDetails.equals(java.lang.Object):boolean");
    }
