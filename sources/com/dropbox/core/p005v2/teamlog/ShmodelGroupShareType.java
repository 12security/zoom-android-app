...
public class ShmodelGroupShareType {
    ...
    static class Serializer extends StructSerializer<ShmodelGroupShareType> {
        ...
        public void serialize(ShmodelGroupShareType shmodelGroupShareType, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            ...
            StoneSerializers.string().serialize(shmodelGroupShareType.description, jsonGenerator);
            if (!z) {
        ...
        public ShmodelGroupShareType deserialize(JsonParser jsonParser, boolean z) throws IOException, JsonParseException {
            ...
            if (str == null) {
                ...
                if (str2 != null) {
                    ...
                    StoneDeserializerLogger.log(shmodelGroupShareType, shmodelGroupShareType.toStringMultiline());
    ...
    public boolean equals(Object obj) {
        ...
        ShmodelGroupShareType shmodelGroupShareType = (ShmodelGroupShareType) obj;
        String str = this.description;
        String str2 = shmodelGroupShareType.description;
