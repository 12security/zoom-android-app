...
/* renamed from: com.dropbox.core.v2.sharing.SharedFolderMembers */
public class SharedFolderMembers {
    ...
    /* renamed from: com.dropbox.core.v2.sharing.SharedFolderMembers$Serializer */
    static class Serializer extends StructSerializer<SharedFolderMembers> {
        ...
        public void serialize(SharedFolderMembers sharedFolderMembers, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            if (!z) {
                jsonGenerator.writeStartObject();
            }
            jsonGenerator.writeFieldName("users");
            StoneSerializers.list(Serializer.INSTANCE).serialize(sharedFolderMembers.users, jsonGenerator);
            jsonGenerator.writeFieldName("groups");
            StoneSerializers.list(Serializer.INSTANCE).serialize(sharedFolderMembers.groups, jsonGenerator);
            jsonGenerator.writeFieldName("invitees");
            StoneSerializers.list(Serializer.INSTANCE).serialize(sharedFolderMembers.invitees, jsonGenerator);
            if (sharedFolderMembers.cursor != null) {
                jsonGenerator.writeFieldName("cursor");
                StoneSerializers.nullable(StoneSerializers.string()).serialize(sharedFolderMembers.cursor, jsonGenerator);
            }
            if (!z) {
        ...
        public SharedFolderMembers deserialize(JsonParser jsonParser, boolean z) throws IOException, JsonParseException {
            String str;
            List list = null;
            if (!z) {
    ...
    public SharedFolderMembers(List<UserMembershipInfo> list, List<GroupMembershipInfo> list2, List<InviteeMembershipInfo> list3, String str) {
        if (list != null) {
            for (UserMembershipInfo userMembershipInfo : list) {
    ...
    public boolean equals(java.lang.Object r5) {
        ...
        L_0x0008:
            ...
            com.dropbox.core.v2.sharing.SharedFolderMembers r5 = (com.dropbox.core.p005v2.sharing.SharedFolderMembers) r5
            java.util.List<com.dropbox.core.v2.sharing.UserMembershipInfo> r2 = r4.users
            java.util.List<com.dropbox.core.v2.sharing.UserMembershipInfo> r3 = r5.users
        ...
        L_0x004d:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dropbox.core.p005v2.sharing.SharedFolderMembers.equals(java.lang.Object):boolean");
    }
