...
/* renamed from: com.dropbox.core.v2.sharing.GetFileMetadataBatchResult */
public class GetFileMetadataBatchResult {
    protected final String file;
    protected final GetFileMetadataIndividualResult result;

    /* renamed from: com.dropbox.core.v2.sharing.GetFileMetadataBatchResult$Serializer */
    static class Serializer extends StructSerializer<GetFileMetadataBatchResult> {
        ...
        public void serialize(GetFileMetadataBatchResult getFileMetadataBatchResult, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            if (!z) {
                jsonGenerator.writeStartObject();
            }
            jsonGenerator.writeFieldName(BoxFile.TYPE);
            StoneSerializers.string().serialize(getFileMetadataBatchResult.file, jsonGenerator);
            jsonGenerator.writeFieldName("result");
            Serializer.INSTANCE.serialize(getFileMetadataBatchResult.result, jsonGenerator);
            if (!z) {
                jsonGenerator.writeEndObject();
            }
        }

        public GetFileMetadataBatchResult deserialize(JsonParser jsonParser, boolean z) throws IOException, JsonParseException {
            String str;
            String str2 = null;
            if (!z) {
            ...
            if (str == null) {
                ...
                while (jsonParser.getCurrentToken() == JsonToken.FIELD_NAME) {
                    ...
                    if (BoxFile.TYPE.equals(currentName)) {
                        ...
                        getFileMetadataIndividualResult = Serializer.INSTANCE.deserialize(jsonParser);
                    } else {
                ...
                } else if (getFileMetadataIndividualResult != null) {
    ...
    public boolean equals(java.lang.Object r5) {
        ...
        L_0x0008:
            ...
            com.dropbox.core.v2.sharing.GetFileMetadataBatchResult r5 = (com.dropbox.core.p005v2.sharing.GetFileMetadataBatchResult) r5
        ...
        L_0x0024:
            com.dropbox.core.v2.sharing.GetFileMetadataIndividualResult r2 = r4.result
            com.dropbox.core.v2.sharing.GetFileMetadataIndividualResult r5 = r5.result
        ...
        L_0x0033:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dropbox.core.p005v2.sharing.GetFileMetadataBatchResult.equals(java.lang.Object):boolean");
    }
