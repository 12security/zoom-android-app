...
/* renamed from: com.dropbox.core.v2.sharing.MemberPermission */
public class MemberPermission {
    protected final MemberAction action;
    protected final boolean allow;
    protected final PermissionDeniedReason reason;

    /* renamed from: com.dropbox.core.v2.sharing.MemberPermission$Serializer */
    static class Serializer extends StructSerializer<MemberPermission> {
        ...
        public void serialize(MemberPermission memberPermission, JsonGenerator jsonGenerator, boolean z) throws IOException, JsonGenerationException {
            if (!z) {
                jsonGenerator.writeStartObject();
            }
            jsonGenerator.writeFieldName(MMContentFileViewerFragment.RESULT_ACTION);
            Serializer.INSTANCE.serialize(memberPermission.action, jsonGenerator);
            jsonGenerator.writeFieldName("allow");
            StoneSerializers.boolean_().serialize(Boolean.valueOf(memberPermission.allow), jsonGenerator);
            if (memberPermission.reason != null) {
                jsonGenerator.writeFieldName(KubiContract.EXTRA_REASON);
                StoneSerializers.nullable(Serializer.INSTANCE).serialize(memberPermission.reason, jsonGenerator);
            }
            if (!z) {
        ...
        public MemberPermission deserialize(JsonParser jsonParser, boolean z) throws IOException, JsonParseException {
            String str;
            ...
            if (str == null) {
                ...
                while (jsonParser.getCurrentToken() == JsonToken.FIELD_NAME) {
                    ...
                    if (MMContentFileViewerFragment.RESULT_ACTION.equals(currentName)) {
                        memberAction = Serializer.INSTANCE.deserialize(jsonParser);
                ...
                if (memberAction == null) {
                    ...
                    StoneDeserializerLogger.log(memberPermission, memberPermission.toStringMultiline());
    ...
    public boolean equals(java.lang.Object r5) {
        ...
        L_0x0008:
            ...
            com.dropbox.core.v2.sharing.MemberPermission r5 = (com.dropbox.core.p005v2.sharing.MemberPermission) r5
            com.dropbox.core.v2.sharing.MemberAction r2 = r4.action
            com.dropbox.core.v2.sharing.MemberAction r3 = r5.action
        ...
        L_0x003b:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dropbox.core.p005v2.sharing.MemberPermission.equals(java.lang.Object):boolean");
    }
