...
/* renamed from: com.dropbox.core.v2.fileproperties.LookupError */
public final class LookupError {
    ...
    /* renamed from: com.dropbox.core.v2.fileproperties.LookupError$Serializer */
        ...
        public void serialize(LookupError lookupError, JsonGenerator jsonGenerator) throws IOException, JsonGenerationException {
            switch (lookupError.tag()) {
                case MALFORMED_PATH:
                    ...
                    StoneSerializers.string().serialize(lookupError.malformedPathValue, jsonGenerator);
        ...
        public LookupError deserialize(JsonParser jsonParser) throws IOException, JsonParseException {
            ...
            if (str != null) {
                if ("malformed_path".equals(str)) {
                    ...
                    lookupError = LookupError.malformedPath((String) StoneSerializers.string().deserialize(jsonParser));
    ...
    /* renamed from: com.dropbox.core.v2.fileproperties.LookupError$Tag */
    public enum Tag {
        MALFORMED_PATH,
        NOT_FOUND,
        NOT_FILE,
