...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0971R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0971R.C0972drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C0971R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0971R.C0973id.icon);
        this.smallLabel = (TextView) findViewById(C0971R.C0973id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0971R.C0973id.largeLabel);
