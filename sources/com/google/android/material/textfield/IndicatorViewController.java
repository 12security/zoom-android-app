...
final class IndicatorViewController {
    ...
    private final float captionTranslationYPx = ((float) this.context.getResources().getDimensionPixelSize(C0971R.dimen.design_textinput_caption_translate_y));
    ...
    private void updateCaptionViewsVisibility(int i, int i2, boolean z) {
        if (z) {
            ...
            final int i5 = i2;
            final int i6 = i;
            C10421 r0 = new AnimatorListenerAdapter() {
    ...
    public void setErrorEnabled(boolean z) {
        if (this.errorEnabled != z) {
            ...
            if (z) {
                ...
                this.errorView.setId(C0971R.C0973id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean z) {
        if (this.helperTextEnabled != z) {
            ...
            if (z) {
                ...
                this.helperTextView.setId(C0971R.C0973id.textinput_helper_text);
                Typeface typeface2 = this.typeface;
                if (typeface2 != null) {
