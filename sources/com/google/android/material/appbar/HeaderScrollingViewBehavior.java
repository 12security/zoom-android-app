    ...
    public boolean onMeasureChild(CoordinatorLayout coordinatorLayout, View view, int i, int i2, int i3, int i4) {
        ...
        if (i5 == -1 || i5 == -2) {
            ...
            if (findFirstDependency != null) {
                ...
                coordinatorLayout.onMeasureChild(view, i, i2, MeasureSpec.makeMeasureSpec((size - findFirstDependency.getMeasuredHeight()) + getScrollRange(findFirstDependency), i5 == -1 ? Ints.MAX_POWER_OF_TWO : Integer.MIN_VALUE), i4);
                return true;
            }
        }
        return false;
