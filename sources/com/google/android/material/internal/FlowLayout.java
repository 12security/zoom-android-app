...
public class FlowLayout extends ViewGroup {
    ...
    private void loadFromAttributes(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C0971R.styleable.FlowLayout, 0, 0);
        this.lineSpacing = obtainStyledAttributes.getDimensionPixelSize(C0971R.styleable.FlowLayout_lineSpacing, 0);
        this.itemSpacing = obtainStyledAttributes.getDimensionPixelSize(C0971R.styleable.FlowLayout_itemSpacing, 0);
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i8 = 0; i8 < getChildCount(); i8++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                paddingLeft = i11 + i4 + i3 + childAt.getMeasuredWidth() + this.itemSpacing;
            }
        }
        setMeasuredDimension(getMeasuredDimension(size, mode, i7), getMeasuredDimension(size2, mode2, paddingTop));
    }
