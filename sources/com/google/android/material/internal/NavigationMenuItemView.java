...
public class NavigationMenuItemView extends ForegroundLinearLayout implements ItemView {
    ...
    public NavigationMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        setOrientation(0);
        LayoutInflater.from(context).inflate(C0971R.layout.design_navigation_menu_item, this, true);
        this.iconSize = context.getResources().getDimensionPixelSize(C0971R.dimen.design_navigation_icon_size);
        this.textView = (CheckedTextView) findViewById(C0971R.C0973id.design_menu_item_text);
    ...
    private void setActionView(View view) {
        if (view != null) {
            if (this.actionArea == null) {
                this.actionArea = (FrameLayout) ((ViewStub) findViewById(C0971R.C0973id.design_menu_item_action_area_stub)).inflate();
            }
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.emptyDrawable == null) {
                this.emptyDrawable = ResourcesCompat.getDrawable(getResources(), C0971R.C0972drawable.navigation_empty_icon, getContext().getTheme());
