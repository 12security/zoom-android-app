...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private float calculateTranslationX(View view, View view2, Positioning positioning) {
        ...
        float f = i != 1 ? i != 3 ? i != 5 ? 0.0f : rectF2.right - rectF.right : rectF2.left - rectF.left : rectF2.centerX() - rectF.centerX();
    ...
    private float calculateTranslationY(View view, View view2, Positioning positioning) {
        ...
        float f = i != 16 ? i != 48 ? i != 80 ? 0.0f : rectF2.bottom - rectF.bottom : rectF2.top - rectF.top : rectF2.centerY() - rectF.centerY();
    ...
    private ViewGroup calculateChildContentContainer(View view) {
        View findViewById = view.findViewById(C0971R.C0973id.mtrl_child_content_container);
