...
abstract class zzia {
    ...
    /* access modifiers changed from: 0000 */
    public abstract String zzh(byte[] bArr, int i, int i2) throws zzfh;
    ...
    static void zzc(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (i3 < length) {
            ...
            if (charAt3 < 128) {
                ...
                int i5 = position + 1;
                try {
                    byteBuffer.put(position, (byte) ((charAt3 >>> 12) | DummyPolicyIDType.zPolicy_SetShortCuts_JumpToSession));
                    position = i5 + 1;
                ...
                if (i6 != length) {
                    try {
                        ...
                        if (Character.isSurrogatePair(charAt3, charAt4)) {
                            ...
                            int i7 = position + 1;
                            try {
                                byteBuffer.put(position, (byte) ((codePoint >>> 18) | DummyPolicyIDType.zPolicy_EnableElevateForAdvDSCP));
                                i = i7 + 1;
                                try {
