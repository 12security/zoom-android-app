    ...
    public final int zzb(int i, byte[] bArr, int i2, int i3) {
        ...
        while (r9 < i3) {
            ...
            if (b >= 0) {
                ...
                int i6 = i4 + 1;
                byte b3 = bArr[i4];
                if (b3 <= -65 && (((b << Ascii.f222FS) + (b3 + 112)) >> 30) == 0) {
                    int i7 = i6 + 1;
                    if (bArr[i6] <= -65) {
                        int i8 = i7 + 1;
                        if (bArr[i7] <= -65) {
            ...
            while (r13 < i3) {
                ...
                if (zzhz.zzd(b2)) {
                    ...
                    if (i7 < i3 - 1) {
                        ...
                        int i13 = i12 + 1;
                        int i14 = i6 + 1;
                        zzhz.zza(b2, bArr[i7], bArr[i12], cArr, i6);
                        r13 = i13;
                        i6 = i14;
                    } else {
                        throw zzfh.zznc();
                    ...
                    int i17 = i16 + 1;
                    int i18 = i6 + 1;
                    zzhz.zza(b2, b4, bArr[i15], bArr[i16], cArr, i6);
                    r13 = i17;
                    i6 = i18 + 1;
                } else {
                    throw zzfh.zznc();
    ...
    public final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i4 < length) {
            ...
            if (charAt2 < 128 && i6 < i3) {
                ...
                int i9 = i6 + 1;
                bArr[i6] = (byte) ((charAt2 >>> 12) | CmmSIPCallFailReason.kSIPCall_FAIL_480_Temporarily_Unavailable);
                int i10 = i9 + 1;
                ...
                if (i12 != charSequence.length()) {
                    ...
                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                        ...
                        int i13 = i6 + 1;
                        bArr[i6] = (byte) ((codePoint >>> 18) | DummyPolicyIDType.zPolicy_EnableElevateForAdvDSCP);
                        int i14 = i13 + 1;
