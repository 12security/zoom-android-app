...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @Field(getter = "getErrorCode", mo23591id = 2)
    private final int zzh;
    @Field(getter = "getResolution", mo23591id = 3)
    private final PendingIntent zzi;
    @Field(getter = "getErrorMessage", mo23591id = 4)
    private final String zzj;

    @Constructor
    ConnectionResult(@Param(mo23594id = 1) int i, @Param(mo23594id = 2) int i2, @Param(mo23594id = 3) PendingIntent pendingIntent, @Param(mo23594id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
