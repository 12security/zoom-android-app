    ...
    public String getVersion(@NonNull String str) {
        ...
        try {
            ...
            if (resourceAsStream != null) {
                ...
                sb.append(str2);
                zzel.mo23535v("LibraryVersion", sb.toString());
            } else {
                GmsLogger gmsLogger = zzel;
                String str3 = "LibraryVersion";
                String str4 = "Failed to get app version for libraryName: ";
                String valueOf = String.valueOf(str);
                gmsLogger.mo23528e(str3, valueOf.length() != 0 ? str4.concat(valueOf) : new String(str4));
            }
        } catch (IOException e) {
            ...
            gmsLogger2.mo23529e(str5, valueOf2.length() != 0 ? str6.concat(valueOf2) : new String(str6), e);
        }
        if (str2 == null) {
            str2 = "UNKNOWN";
            zzel.mo23526d("LibraryVersion", ".properties file is dropped during release process. Failure to read app version isexpected druing Google internal testing where locally-built libraries are used");
        }
