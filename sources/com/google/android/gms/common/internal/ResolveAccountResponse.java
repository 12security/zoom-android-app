...
public class ResolveAccountResponse extends AbstractSafeParcelable {
    ...
    @Field(getter = "getConnectionResult", mo23591id = 3)
    private ConnectionResult zadh;
    @Field(getter = "getSaveDefaultAccount", mo23591id = 4)
    private boolean zagf;
    @VersionField(mo23597id = 1)
    private final int zale;
    @Field(mo23591id = 2)
    private IBinder zanw;
    @Field(getter = "isFromCrossClientAuth", mo23591id = 5)
    private boolean zapb;

    @Constructor
    ResolveAccountResponse(@Param(mo23594id = 1) int i, @Param(mo23594id = 2) IBinder iBinder, @Param(mo23594id = 3) ConnectionResult connectionResult, @Param(mo23594id = 4) boolean z, @Param(mo23594id = 5) boolean z2) {
        this.zale = i;
        this.zanw = iBinder;
