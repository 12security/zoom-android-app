...
public class ResolveAccountRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getSessionId", mo23591id = 3)
    private final int zaoz;
    @Field(getter = "getSignInAccountHint", mo23591id = 4)
    private final GoogleSignInAccount zapa;
    @Field(getter = "getAccount", mo23591id = 2)
    private final Account zax;

    @Constructor
    ResolveAccountRequest(@Param(mo23594id = 1) int i, @Param(mo23594id = 2) Account account, @Param(mo23594id = 3) int i2, @Param(mo23594id = 4) GoogleSignInAccount googleSignInAccount) {
        this.zale = i;
        this.zax = account;
        this.zaoz = i2;
