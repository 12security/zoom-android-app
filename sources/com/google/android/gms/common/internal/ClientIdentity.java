...
public class ClientIdentity extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "null", mo23591id = 2)
    @Nullable
    private final String packageName;
    @Field(defaultValueUnchecked = "0", mo23591id = 1)
    private final int uid;

    @Constructor
    public ClientIdentity(@Param(mo23594id = 1) int i, @Param(mo23594id = 2) @Nullable String str) {
        this.uid = i;
