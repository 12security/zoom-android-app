...
public class AuthAccountRequest extends AbstractSafeParcelable {
    ...
    @Field(mo23591id = 6, type = "android.accounts.Account")
    private Account zax;

    @Constructor
    AuthAccountRequest(@Param(mo23594id = 1) int i, @Param(mo23594id = 2) IBinder iBinder, @Param(mo23594id = 3) Scope[] scopeArr, @Param(mo23594id = 4) Integer num, @Param(mo23594id = 5) Integer num2, @Param(mo23594id = 6) Account account) {
        this.zale = i;
        this.zanw = iBinder;
        this.zanx = scopeArr;
        this.zany = num;
