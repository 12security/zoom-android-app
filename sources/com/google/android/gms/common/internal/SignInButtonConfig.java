...
public class SignInButtonConfig extends AbstractSafeParcelable {
    ...
    @Field(getter = "getScopes", mo23591id = 4)
    @Deprecated
    private final Scope[] zanx;
    @Field(getter = "getButtonSize", mo23591id = 2)
    private final int zapc;
    @Field(getter = "getColorScheme", mo23591id = 3)
    private final int zapd;

    @Constructor
    SignInButtonConfig(@Param(mo23594id = 1) int i, @Param(mo23594id = 2) int i2, @Param(mo23594id = 3) int i3, @Param(mo23594id = 4) Scope[] scopeArr) {
        this.zale = i;
        this.zapc = i2;
        this.zapd = i3;
        this.zanx = scopeArr;
