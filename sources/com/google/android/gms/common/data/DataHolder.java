...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @VersionField(mo23597id = 1000)
    private final int zale;
    @Field(getter = "getColumns", mo23591id = 1)
    private final String[] zalp;
    private Bundle zalq;
    @Field(getter = "getWindows", mo23591id = 2)
    private final CursorWindow[] zalr;
    @Field(getter = "getStatusCode", mo23591id = 3)
    private final int zals;
    @Field(getter = "getMetadata", mo23591id = 4)
    ...
    @Constructor
    DataHolder(@Param(mo23594id = 1000) int i, @Param(mo23594id = 1) String[] strArr, @Param(mo23594id = 2) CursorWindow[] cursorWindowArr, @Param(mo23594id = 3) int i2, @Param(mo23594id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalw = true;
        this.zale = i;
        this.zalp = strArr;
    ...
    public final void finalize() throws Throwable {
        try {
            if (this.zalw && this.zalr.length > 0 && !isClosed()) {
                close();
                String obj = toString();
                StringBuilder sb = new StringBuilder(String.valueOf(obj).length() + DummyPolicyIDType.zPolicy_SetVideoBackgroundData);
