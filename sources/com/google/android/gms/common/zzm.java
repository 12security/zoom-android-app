...
class zzm {
    ...
    static String zzc(String str, zze zze, boolean z, boolean z2) {
        return String.format("%s: pkg=%s, sha1=%s, atk=%s, ver=%s", new Object[]{z2 ? "debug cert rejected" : "not whitelisted", str, Hex.bytesToStringLowercase(AndroidUtilsLight.zzj(MessageDigestAlgorithms.SHA_1).digest(zze.getBytes())), Boolean.valueOf(z), "12451009.false"});
    }
}
