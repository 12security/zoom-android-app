...
public class Feature extends AbstractSafeParcelable {
    ...
    @Field(getter = "getName", mo23591id = 1)
    private final String name;
    @Field(getter = "getOldVersion", mo23591id = 2)
    @Deprecated
    private final int zzk;
    @Field(defaultValue = "-1", getter = "getVersion", mo23591id = 3)
    ...
    @Constructor
    public Feature(@Param(mo23594id = 1) String str, @Param(mo23594id = 2) int i, @Param(mo23594id = 3) long j) {
        this.name = str;
        this.zzk = i;
        this.zzl = j;
    }
