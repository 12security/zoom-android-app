...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        @VersionField(getter = "getVersionCode", mo23597id = 1)
        private final int zale;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getTypeIn", mo23591id = 2)
        protected final int zapq;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "isTypeInArray", mo23591id = 3)
        protected final boolean zapr;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getTypeOut", mo23591id = 4)
        protected final int zaps;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "isTypeOutArray", mo23591id = 5)
        protected final boolean zapt;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getOutputFieldName", mo23591id = 6)
        protected final String zapu;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getSafeParcelableFieldId", mo23591id = 7)
        protected final int zapv;
        protected final Class<? extends FastJsonResponse> zapw;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getConcreteTypeName", mo23591id = 8)
        private final String zapx;
        private zak zapy;
        /* access modifiers changed from: private */
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getWrappedConverter", mo23591id = 9, type = "com.google.android.gms.common.server.converter.ConverterWrapper")
        public FieldConverter<I, O> zapz;

        @Constructor
        Field(@Param(mo23594id = 1) int i, @Param(mo23594id = 2) int i2, @Param(mo23594id = 3) boolean z, @Param(mo23594id = 4) int i3, @Param(mo23594id = 5) boolean z2, @Param(mo23594id = 6) String str, @Param(mo23594id = 7) int i4, @Param(mo23594id = 8) String str2, @Param(mo23594id = 9) zaa zaa) {
            this.zale = i;
            this.zapq = i2;
            this.zapr = z;
            this.zaps = i3;
