...
public final class zak extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo23591id = 2)
    private final ArrayList<zal> zaqv;
    @SafeParcelable.Field(getter = "getRootClassName", mo23591id = 3)
    private final String zaqw;

    @Constructor
    zak(@Param(mo23594id = 1) int i, @Param(mo23594id = 2) ArrayList<zal> arrayList, @Param(mo23594id = 3) String str) {
        this.zale = i;
        this.zaqv = null;
