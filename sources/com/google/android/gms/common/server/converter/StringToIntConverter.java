...
public final class StringToIntConverter extends AbstractSafeParcelable implements FieldConverter<String, Integer> {
    ...
    @Field(getter = "getSerializedMap", mo23591id = 2)
    ...
    public static final class zaa extends AbstractSafeParcelable {
        ...
        @Constructor
        zaa(@Param(mo23594id = 1) int i, @Param(mo23594id = 2) String str, @Param(mo23594id = 3) int i2) {
            this.versionCode = i;
            this.zapo = str;
            this.zapp = i2;
        }
    ...
    @Constructor
    StringToIntConverter(@Param(mo23594id = 1) int i, @Param(mo23594id = 2) ArrayList<zaa> arrayList) {
        this.zale = i;
