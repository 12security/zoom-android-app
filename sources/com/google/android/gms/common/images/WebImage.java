...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @Field(getter = "getWidth", mo23591id = 3)
    private final int zand;
    @Field(getter = "getHeight", mo23591id = 4)
    private final int zane;
    @Field(getter = "getUrl", mo23591id = 2)
    private final Uri zanf;

    @Constructor
    WebImage(@Param(mo23594id = 1) int i, @Param(mo23594id = 2) Uri uri, @Param(mo23594id = 3) int i2, @Param(mo23594id = 4) int i3) {
        this.zale = i;
        this.zanf = uri;
        this.zand = i2;
        this.zane = i3;
