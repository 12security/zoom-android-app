...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @Field(getter = "getStatusCode", mo23591id = 1)
    private final int zzh;
    @Field(getter = "getPendingIntent", mo23591id = 3)
    @Nullable
    private final PendingIntent zzi;
    @Field(getter = "getStatusMessage", mo23591id = 2)
    @Nullable
    private final String zzj;

    @Constructor
    @KeepForSdk
    Status(@Param(mo23594id = 1000) int i, @Param(mo23594id = 1) int i2, @Param(mo23594id = 2) @Nullable String str, @Param(mo23594id = 3) @Nullable PendingIntent pendingIntent) {
        this.zzg = i;
        this.zzh = i2;
        this.zzj = str;
