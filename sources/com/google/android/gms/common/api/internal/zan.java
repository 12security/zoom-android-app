    ...
    public final void run() {
        if (this.zadj.mStarted) {
            ...
            if (connectionResult.hasResolution()) {
                ...
                this.zadj.zacc.zaa(this.zadj.getActivity().getApplicationContext(), (zabr) new zao(this, GoogleApiAvailability.zaa(this.zadj.getActivity(), (OnCancelListener) this.zadj)));
            } else {
