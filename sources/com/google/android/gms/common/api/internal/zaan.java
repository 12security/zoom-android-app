    ...
    public final void zaan() {
        ...
        if (!arrayList.isEmpty()) {
            ...
            while (i2 < size2) {
                ...
                i2++;
                i = googleApiAvailabilityCache.getClientAvailability(this.zagi.mContext, (Client) obj2);
                if (i == 0) {
                    break;
                }
            }
        ...
        if (i != 0) {
            this.zagi.zafs.zaa((zabf) new zaao(this, this.zagi, new ConnectionResult(i, null)));
            return;
        }
        if (this.zagi.zagc) {
