...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @Field(getter = "getBundle", mo23591id = 3)
    private Bundle mBundle;
    @Field(getter = "getType", mo23591id = 2)
    private int mType;
    @VersionField(mo23597id = 1)
    private final int versionCode;

    @Constructor
    GoogleSignInOptionsExtensionParcelable(@Param(mo23594id = 1) int i, @Param(mo23594id = 2) int i2, @Param(mo23594id = 3) Bundle bundle) {
        this.versionCode = i;
        this.mType = i2;
        this.mBundle = bundle;
    }
