...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Optional, ReflectedParcelable {
    ...
    @Field(getter = "isForceCodeForRefreshToken", mo23591id = 6)
    public final boolean zaaa;
    /* access modifiers changed from: private */
    @Field(getter = "getServerClientId", mo23591id = 7)
    public String zaab;
    /* access modifiers changed from: private */
    @Field(getter = "getHostedDomain", mo23591id = 8)
    public String zaac;
    /* access modifiers changed from: private */
    @Field(getter = "getExtensions", mo23591id = 9)
    ...
    /* access modifiers changed from: private */
    @Field(getter = "getScopes", mo23591id = 2)
    public final ArrayList<Scope> zaw;
    /* access modifiers changed from: private */
    @Field(getter = "getAccount", mo23591id = 3)
    public Account zax;
    /* access modifiers changed from: private */
    @Field(getter = "isIdTokenRequested", mo23591id = 4)
    public boolean zay;
    /* access modifiers changed from: private */
    @Field(getter = "isServerAuthCodeRequested", mo23591id = 5)
    ...
    @Constructor
    GoogleSignInOptions(@Param(mo23594id = 1) int i, @Param(mo23594id = 2) ArrayList<Scope> arrayList, @Param(mo23594id = 3) Account account, @Param(mo23594id = 4) boolean z, @Param(mo23594id = 5) boolean z2, @Param(mo23594id = 6) boolean z3, @Param(mo23594id = 7) String str, @Param(mo23594id = 8) String str2, @Param(mo23594id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {
    ...
    public boolean equals(java.lang.Object r4) {
        ...
        L_0x0004:
            ...
            java.util.ArrayList<com.google.android.gms.auth.api.signin.internal.GoogleSignInOptionsExtensionParcelable> r1 = r3.zaad     // Catch:{ ClassCastException -> 0x0088 }
            int r1 = r1.size()     // Catch:{ ClassCastException -> 0x0088 }
            if (r1 > 0) goto L_0x0087
            java.util.ArrayList<com.google.android.gms.auth.api.signin.internal.GoogleSignInOptionsExtensionParcelable> r1 = r4.zaad     // Catch:{ ClassCastException -> 0x0088 }
            int r1 = r1.size()     // Catch:{ ClassCastException -> 0x0088 }
            if (r1 <= 0) goto L_0x0018
            goto L_0x0087
        L_0x0018:
            java.util.ArrayList<com.google.android.gms.common.api.Scope> r1 = r3.zaw     // Catch:{ ClassCastException -> 0x0088 }
            int r1 = r1.size()     // Catch:{ ClassCastException -> 0x0088 }
            java.util.ArrayList r2 = r4.getScopes()     // Catch:{ ClassCastException -> 0x0088 }
            ...
            goto L_0x0086
        L_0x0035:
            android.accounts.Account r1 = r3.zax     // Catch:{ ClassCastException -> 0x0088 }
            if (r1 != 0) goto L_0x0040
            android.accounts.Account r1 = r4.getAccount()     // Catch:{ ClassCastException -> 0x0088 }
            if (r1 != 0) goto L_0x0085
            goto L_0x004c
        L_0x0040:
            android.accounts.Account r1 = r3.zax     // Catch:{ ClassCastException -> 0x0088 }
            android.accounts.Account r2 = r4.getAccount()     // Catch:{ ClassCastException -> 0x0088 }
            boolean r1 = r1.equals(r2)     // Catch:{ ClassCastException -> 0x0088 }
            if (r1 == 0) goto L_0x0085
        L_0x004c:
            java.lang.String r1 = r3.zaab     // Catch:{ ClassCastException -> 0x0088 }
            boolean r1 = android.text.TextUtils.isEmpty(r1)     // Catch:{ ClassCastException -> 0x0088 }
            if (r1 == 0) goto L_0x005f
            java.lang.String r1 = r4.getServerClientId()     // Catch:{ ClassCastException -> 0x0088 }
            boolean r1 = android.text.TextUtils.isEmpty(r1)     // Catch:{ ClassCastException -> 0x0088 }
            if (r1 == 0) goto L_0x0085
            goto L_0x006b
        L_0x005f:
            java.lang.String r1 = r3.zaab     // Catch:{ ClassCastException -> 0x0088 }
            java.lang.String r2 = r4.getServerClientId()     // Catch:{ ClassCastException -> 0x0088 }
            boolean r1 = r1.equals(r2)     // Catch:{ ClassCastException -> 0x0088 }
            if (r1 == 0) goto L_0x0085
        L_0x006b:
            boolean r1 = r3.zaaa     // Catch:{ ClassCastException -> 0x0088 }
            boolean r2 = r4.isForceCodeForRefreshToken()     // Catch:{ ClassCastException -> 0x0088 }
            if (r1 != r2) goto L_0x0085
            boolean r1 = r3.zay     // Catch:{ ClassCastException -> 0x0088 }
            boolean r2 = r4.isIdTokenRequested()     // Catch:{ ClassCastException -> 0x0088 }
            if (r1 != r2) goto L_0x0085
            boolean r1 = r3.zaz     // Catch:{ ClassCastException -> 0x0088 }
            boolean r4 = r4.isServerAuthCodeRequested()     // Catch:{ ClassCastException -> 0x0088 }
