...
public final class zaj extends AbstractSafeParcelable {
    ...
    @Field(getter = "getConnectionResult", mo23591id = 2)
    private final ConnectionResult zadh;
    @VersionField(mo23597id = 1)
    private final int zale;
    @Field(getter = "getResolveAccountResponse", mo23591id = 3)
    private final ResolveAccountResponse zasb;

    @Constructor
    zaj(@Param(mo23594id = 1) int i, @Param(mo23594id = 2) ConnectionResult connectionResult, @Param(mo23594id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zale = i;
