...
public final class zaa extends AbstractSafeParcelable implements Result {
    ...
    @Field(getter = "getConnectionResultCode", mo23591id = 2)
    private int zarw;
    @Field(getter = "getRawAuthResolutionIntent", mo23591id = 3)
    private Intent zarx;

    @Constructor
    zaa(@Param(mo23594id = 1) int i, @Param(mo23594id = 2) int i2, @Param(mo23594id = 3) Intent intent) {
        this.zale = i;
        this.zarw = i2;
        this.zarx = intent;
    }
