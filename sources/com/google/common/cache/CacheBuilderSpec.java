...
public final class CacheBuilderSpec {
    private static final Splitter KEYS_SPLITTER = Splitter.m94on(',').trimResults();
    private static final Splitter KEY_VALUE_SPLITTER = Splitter.m94on('=').trimResults();
    ...
    public CacheBuilder<Object, Object> toCacheBuilder() {
        ...
        if (this.keyStrength != null) {
            if (C11251.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.keyStrength.ordinal()] == 1) {
                newBuilder.weakKeys();
            } else {
