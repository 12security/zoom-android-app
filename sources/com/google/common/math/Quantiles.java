    ...
    public static final class ScaleAndIndexes {
        ...
        public Map<Integer, Double> computeInPlace(double... dArr) {
            ...
            while (true) {
                ...
                int i6 = iArr4[i];
                if (i6 == 0) {
                    hashMap2.put(Integer.valueOf(iArr7[i]), Double.valueOf(dArr2[i5]));
                } else {
                    hashMap2.put(Integer.valueOf(iArr7[i]), Double.valueOf(Quantiles.interpolate(dArr2[i5], dArr2[i5 + 1], (double) i6, (double) this.scale)));
                }
                i++;
            }
        }
