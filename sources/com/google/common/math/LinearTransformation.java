...
public abstract class LinearTransformation {
    ...
    public static final class LinearTransformationBuilder {
        ...
        /* renamed from: x1 */
        private final double f284x1;

        /* renamed from: y1 */
        private final double f285y1;
        ...
        public LinearTransformation and(double d, double d2) {
            ...
            double d3 = this.f284x1;
            if (d != d3) {
                return withSlope((d2 - this.f285y1) / (d - d3));
            }
            if (d2 == this.f285y1) {
                z = false;
            }
            Preconditions.checkArgument(z);
            return new VerticalLinearTransformation(this.f284x1);
        }

        public LinearTransformation withSlope(double d) {
            Preconditions.checkArgument(!Double.isNaN(d));
            if (DoubleUtils.isFinite(d)) {
                return new RegularLinearTransformation(d, this.f285y1 - (this.f284x1 * d));
            }
            return new VerticalLinearTransformation(this.f284x1);
        }
    }
    ...
    private static final class VerticalLinearTransformation extends LinearTransformation {
        ...
        public String toString() {
            return String.format("x = %g", new Object[]{Double.valueOf(this.f286x)});
        }

        private LinearTransformation createInverse() {
            RegularLinearTransformation regularLinearTransformation = new RegularLinearTransformation(0.0d, this.f286x, this);
            return regularLinearTransformation;
        }
    }
