...
public final class DoubleMath {
    ...
    static /* synthetic */ class C14551 {
        ...
        static {
            ...
            L_0x0062:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.DoubleMath.C14551.<clinit>():void");
        }
    }
    ...
    static double roundIntermediate(double d, RoundingMode roundingMode) {
        if (DoubleUtils.isFinite(d)) {
            switch (C14551.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
