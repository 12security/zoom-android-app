...
final class DirectedMultiNetworkConnections<N, E> extends AbstractDirectedNetworkConnections<N, E> {
    ...
    /* renamed from: of */
    static <N, E> DirectedMultiNetworkConnections<N, E> m209of() {
    ...
    private Multiset<N> predecessorsMultiset() {
        ...
        HashMultiset create = HashMultiset.create((Iterable<? extends E>) this.inEdgeMap.values());
    ...
    public Multiset<N> successorsMultiset() {
        ...
        HashMultiset create = HashMultiset.create((Iterable<? extends E>) this.outEdgeMap.values());
        this.successorsReference = new SoftReference(create);
        return create;
    }

    public Set<E> edgesConnecting(final Object obj) {
        return new MultiEdgesConnecting<E>(this.outEdgeMap, obj) {
            public int size() {
