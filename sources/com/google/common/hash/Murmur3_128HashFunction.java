...
final class Murmur3_128HashFunction extends AbstractStreamingHashFunction implements Serializable {
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        /* renamed from: C1 */
        private static final long f263C1 = -8663945395140668459L;

        /* renamed from: C2 */
        private static final long f264C2 = 5545529020109919103L;
        ...
        private void bmix64(long j, long j2) {
            this.f265h1 = mixK1(j) ^ this.f265h1;
            this.f265h1 = Long.rotateLeft(this.f265h1, 27);
            long j3 = this.f265h1;
            long j4 = this.f266h2;
            this.f265h1 = j3 + j4;
            this.f265h1 = (this.f265h1 * 5) + 1390208809;
            this.f266h2 = mixK2(j2) ^ j4;
            this.f266h2 = Long.rotateLeft(this.f266h2, 31);
            this.f266h2 += this.f265h1;
            this.f266h2 = (this.f266h2 * 5) + 944331445;
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x00f6, code lost:
            r11.f265h1 = mixK1(r2) ^ r11.f265h1;
            r11.f266h2 = mixK2(r0) ^ r11.f266h2;
         */
        ...
        public HashCode makeHash() {
            ...
            long j4 = this.f265h1;
            this.f266h2 = j3 + j4;
            this.f265h1 = fmix64(j4);
            this.f266h2 = fmix64(this.f266h2);
            long j5 = this.f265h1;
            long j6 = this.f266h2;
            this.f265h1 = j5 + j6;
            this.f266h2 = j6 + this.f265h1;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f265h1).putLong(this.f266h2).array());
        }

        private static long mixK1(long j) {
            return Long.rotateLeft(j * f263C1, 31) * f264C2;
        }

        private static long mixK2(long j) {
            return Long.rotateLeft(j * f264C2, 33) * f263C1;
        }
    }
