...
public final class Splitter {
    ...
    public static final class MapSplitter {
        ...
        public Map<String, String> split(CharSequence charSequence) {
            ...
            for (String str : this.outerSplitter.split(charSequence)) {
                ...
                Preconditions.checkArgument(access$000.hasNext(), INVALID_ENTRY_MESSAGE, (Object) str);
    ...
    /* renamed from: on */
    public static Splitter m94on(char c) {
        return m95on(CharMatcher.m75is(c));
    }

    /* renamed from: on */
    public static Splitter m95on(final CharMatcher charMatcher) {
    ...
    /* renamed from: on */
    public static Splitter m97on(final String str) {
        Preconditions.checkArgument(str.length() != 0, "The separator may not be the empty string.");
        if (str.length() == 1) {
            return m94on(str.charAt(0));
        }
        return new Splitter(new Strategy() {
            public SplittingIterator iterator(Splitter splitter, CharSequence charSequence) {
                return new SplittingIterator(splitter, charSequence) {
    ...
    @GwtIncompatible
    /* renamed from: on */
    public static Splitter m98on(Pattern pattern) {
        return m96on((CommonPattern) new JdkPattern(pattern));
    }

    /* renamed from: on */
    private static Splitter m96on(final CommonPattern commonPattern) {
    ...
    public static Splitter onPattern(String str) {
        return m96on(Platform.compilePattern(str));
    }
    ...
    public MapSplitter withKeyValueSeparator(String str) {
        return withKeyValueSeparator(m97on(str));
    }

    @Beta
    public MapSplitter withKeyValueSeparator(char c) {
        return withKeyValueSeparator(m94on(c));
    }
