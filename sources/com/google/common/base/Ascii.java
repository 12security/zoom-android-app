...
public final class Ascii {
    ...
    /* renamed from: BS */
    public static final byte f218BS = 8;
    public static final byte CAN = 24;

    /* renamed from: CR */
    public static final byte f219CR = 13;
    ...
    /* renamed from: EM */
    public static final byte f220EM = 25;
    ...
    /* renamed from: FF */
    public static final byte f221FF = 12;

    /* renamed from: FS */
    public static final byte f222FS = 28;

    /* renamed from: GS */
    public static final byte f223GS = 29;

    /* renamed from: HT */
    public static final byte f224HT = 9;

    /* renamed from: LF */
    public static final byte f225LF = 10;
    public static final char MAX = '';
    public static final char MIN = '\u0000';
    public static final byte NAK = 21;

    /* renamed from: NL */
    public static final byte f226NL = 10;
    public static final byte NUL = 0;

    /* renamed from: RS */
    public static final byte f227RS = 30;

    /* renamed from: SI */
    public static final byte f228SI = 15;

    /* renamed from: SO */
    public static final byte f229SO = 14;
    public static final byte SOH = 1;

    /* renamed from: SP */
    public static final byte f230SP = 32;
    ...
    /* renamed from: US */
    public static final byte f231US = 31;

    /* renamed from: VT */
    public static final byte f232VT = 11;
    public static final byte XOFF = 19;
    public static final byte XON = 17;

    private static int getAlphaIndex(char c) {
        return (char) ((c | TokenParser.f498SP) - 'a');
    }
        ...
        while (i < length) {
            if (isUpperCase(str.charAt(i))) {
                ...
                while (i < length) {
                    char c = charArray[i];
                    if (isUpperCase(c)) {
                        charArray[i] = (char) (c ^ TokenParser.f498SP);
                    }
                    i++;
                }
    ...
    public static char toLowerCase(char c) {
        return isUpperCase(c) ? (char) (c ^ TokenParser.f498SP) : c;
    }
    ...
    public static java.lang.String truncate(java.lang.CharSequence r5, int r6, java.lang.String r7) {
        ...
        L_0x000f:
            ...
            int r4 = r7.length()
            com.google.common.base.Preconditions.checkArgument(r2, r3, r6, r4)
            int r2 = r5.length()
