...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    private static final class Any extends NamedFastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo29307or(CharMatcher charMatcher) {
    ...
    private static final class C1091Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo29307or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo29307or(charMatcher);
        }
    ...
    private static final class C1092Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C1092Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    /* renamed from: is */
    public static CharMatcher m75is(char c) {
        return new C1091Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        switch (charSequence.length()) {
            case 0:
                return none();
            case 1:
                return m75is(charSequence.charAt(0));
            case 2:
    ...
    /* renamed from: or */
    public CharMatcher mo29307or(CharMatcher charMatcher) {
        return new C1092Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        switch (i) {
            case 0:
                return none();
            case 1:
                return m75is((char) bitSet.nextSetBit(0));
            case 2:
