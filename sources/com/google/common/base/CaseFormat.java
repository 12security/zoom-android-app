...
public enum CaseFormat {
    LOWER_HYPHEN(CharMatcher.m75is('-'), "-") {
    ...
    LOWER_UNDERSCORE(CharMatcher.m75is('_'), "_") {
        /* access modifiers changed from: 0000 */
        public String normalizeWord(String str) {
            return Ascii.toLowerCase(str);
        }
    ...
    UPPER_UNDERSCORE(CharMatcher.m75is('_'), "_") {
        /* access modifiers changed from: 0000 */
        public String normalizeWord(String str) {
            return Ascii.toUpperCase(str);
        }
    ...
    private static final class StringConverter extends Converter<String, String> implements Serializable {
        ...
        public String doForward(String str) {
            return this.sourceFormat.mo29286to(this.targetFormat, str);
        }

        /* access modifiers changed from: protected */
        public String doBackward(String str) {
            return this.targetFormat.mo29286to(this.sourceFormat, str);
        }
    ...
    /* renamed from: to */
    public final String mo29286to(CaseFormat caseFormat, String str) {
