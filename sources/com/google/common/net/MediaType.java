...
public final class MediaType {
    ...
    private static final MapJoiner PARAMETER_JOINER = Joiner.m82on("; ").withKeyValueSeparator("=");
    ...
    public static final CharMatcher TOKEN_MATCHER = CharMatcher.ascii().and(CharMatcher.javaIsoControl().negate()).and(CharMatcher.isNot(TokenParser.f498SP)).and(CharMatcher.noneOf("()<>@,;:\\\"/[]?="));
    public static final MediaType TSV_UTF_8 = createConstantUtf8("text", "tab-separated-values");
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m127of(CHARSET_ATTRIBUTE, Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    private static MediaType createConstant(String str, String str2) {
        return addKnownType(new MediaType(str, str2, ImmutableListMultimap.m126of()));
    }
    ...
    public Optional<Charset> charset() {
        ...
        switch (copyOf.size()) {
            ...
            case 1:
                return Optional.m83of(Charset.forName((String) Iterables.getOnlyElement(copyOf)));
            default:
    ...
    /* renamed from: is */
    public boolean mo32713is(MediaType mediaType) {
    ...
    public static MediaType create(String str, String str2) {
        return create(str, str2, ImmutableListMultimap.m126of());
    }
