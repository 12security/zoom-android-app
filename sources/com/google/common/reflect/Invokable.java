...
public abstract class Invokable<T, R> extends Element implements GenericDeclaration {
    ...
    public final TypeToken<? extends R> getReturnType() {
        return TypeToken.m227of(getGenericReturnType());
    }
    ...
    public final ImmutableList<Parameter> getParameters() {
        ...
        for (int i = 0; i < genericParameterTypes.length; i++) {
            builder.add((Object) new Parameter(this, i, TypeToken.m227of(genericParameterTypes[i]), parameterAnnotations[i]));
        }
    ...
    public final ImmutableList<TypeToken<? extends Throwable>> getExceptionTypes() {
        ...
        for (Type of : getGenericExceptionTypes()) {
            builder.add((Object) TypeToken.m227of(of));
        }
        return builder.build();
    }

    public final <R1 extends R> Invokable<T, R1> returning(Class<R1> cls) {
        return returning(TypeToken.m226of(cls));
    }
    ...
    public TypeToken<T> getOwnerType() {
        return TypeToken.m226of(getDeclaringClass());
    }
}
