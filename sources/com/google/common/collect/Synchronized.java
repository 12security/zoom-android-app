...
final class Synchronized {
    ...
    private static class SynchronizedAsMapEntries<K, V> extends SynchronizedSet<Entry<K, Collection<V>>> {
        ...
        public Iterator<Entry<K, Collection<V>>> iterator() {
            return new TransformedIterator<Entry<K, Collection<V>>, Entry<K, Collection<V>>>(super.iterator()) {
                ...
                public Entry<K, Collection<V>> transform(final Entry<K, Collection<V>> entry) {
    ...
    /* access modifiers changed from: private */
    @GwtIncompatible
    public static <K, V> Entry<K, V> nullableSynchronizedEntry(@Nullable Entry<K, V> entry, @Nullable Object obj) {
        if (entry == null) {
            return null;
        }
