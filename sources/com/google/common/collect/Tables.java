...
public final class Tables {
    ...
    private static class TransformedTable<R, C, V1, V2> extends AbstractTable<R, C, V2> {
        ...
        public Map<R, Map<C, V2>> rowMap() {
            return Maps.transformValues(this.fromTable.rowMap(), (Function<? super V1, V2>) new Function<Map<C, V1>, Map<C, V2>>() {
        ...
        public Map<C, Map<R, V2>> columnMap() {
            return Maps.transformValues(this.fromTable.columnMap(), (Function<? super V1, V2>) new Function<Map<R, V1>, Map<R, V2>>() {
