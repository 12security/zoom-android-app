        ...
        class SubRangeMapAsMap extends AbstractMap<Range<K>, V> {
            ...
            public Set<Range<K>> keySet() {
                return new KeySet<Range<K>, V>(this) {
                    ...
                    public boolean retainAll(Collection<?> collection) {
                        return SubRangeMapAsMap.this.removeEntryIf(Predicates.compose(Predicates.not(Predicates.m87in(collection)), Maps.keyFunction()));
                    }
                };
            }
            ...
            public Set<Entry<Range<K>, V>> entrySet() {
                return new EntrySet<Range<K>, V>() {
                    ...
                    public boolean retainAll(Collection<?> collection) {
                        return SubRangeMapAsMap.this.removeEntryIf(Predicates.not(Predicates.m87in(collection)));
                    }
            ...
            public Collection<V> values() {
                return new Values<Range<K>, V>(this) {
                    public boolean removeAll(Collection<?> collection) {
                        return SubRangeMapAsMap.this.removeEntryIf(Predicates.compose(Predicates.m87in(collection), Maps.valueFunction()));
                    }

                    public boolean retainAll(Collection<?> collection) {
                        return SubRangeMapAsMap.this.removeEntryIf(Predicates.compose(Predicates.not(Predicates.m87in(collection)), Maps.valueFunction()));
                    }
                };
            }
        }
