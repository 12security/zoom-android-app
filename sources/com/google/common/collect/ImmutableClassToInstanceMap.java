...
public final class ImmutableClassToInstanceMap<B> extends ForwardingMap<Class<? extends B>, B> implements ClassToInstanceMap<B>, Serializable {
    private static final ImmutableClassToInstanceMap<Object> EMPTY = new ImmutableClassToInstanceMap<>(ImmutableMap.m132of());
    ...
    public static final class Builder<B> {
        ...
        public ImmutableClassToInstanceMap<B> build() {
            ...
            if (build.isEmpty()) {
                return ImmutableClassToInstanceMap.m111of();
            }
    ...
    /* renamed from: of */
    public static <B> ImmutableClassToInstanceMap<B> m111of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <B, T extends B> ImmutableClassToInstanceMap<B> m112of(Class<T> cls, T t) {
        return new ImmutableClassToInstanceMap<>(ImmutableMap.m133of(cls, t));
    }
