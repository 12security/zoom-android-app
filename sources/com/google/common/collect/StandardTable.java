    ...
    private class Column extends ViewCachingAbstractMap<R, V> {
        ...
        private class EntrySet extends ImprovedAbstractSet<Entry<R, V>> {
            ...
            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Predicates.not(Predicates.m87in(collection)));
            }
        }
        ...
        private class KeySet extends KeySet<R, V> {
            ...
            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.m87in(collection))));
            }
        }
        ...
        private class Values extends Values<R, V> {
            ...
            public boolean removeAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.m87in(collection)));
            }

            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.m87in(collection))));
            }
        }
