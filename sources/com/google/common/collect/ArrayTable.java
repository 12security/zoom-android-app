...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    private class Column extends ArrayMap<R, V> {
        ...
        public V getValue(int i) {
            return ArrayTable.this.mo30209at(i, this.columnIndex);
        }
    ...
    private class Row extends ArrayMap<C, V> {
        ...
        /* access modifiers changed from: 0000 */
        public V getValue(int i) {
            return ArrayTable.this.mo30209at(this.rowIndex, i);
        }
    ...
    /* renamed from: at */
    public V mo30209at(int i, int i2) {
    ...
    public V get(@Nullable Object obj, @Nullable Object obj2) {
        ...
        return mo30209at(num.intValue(), num2.intValue());
    }
        ...
        return new AbstractIndexedListIterator<Cell<R, C, V>>(size()) {
            ...
            public Cell<R, C, V> get(final int i) {
                return new AbstractCell<R, C, V>() {
                    ...
                    public V getValue() {
                        return ArrayTable.this.mo30209at(this.rowIndex, this.columnIndex);
                    }
                };
            }
        };
    ...
    public Map<R, V> column(C c) {
        ...
        return num == null ? ImmutableMap.m132of() : new Column(num.intValue());
    }
    ...
    public Map<C, V> row(R r) {
        Preconditions.checkNotNull(r);
        Integer num = (Integer) this.rowKeyToIndex.get(r);
        return num == null ? ImmutableMap.m132of() : new Row(num.intValue());
    }
