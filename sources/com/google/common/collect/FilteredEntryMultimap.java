    ...
    class AsMap extends ViewCachingAbstractMap<K, Collection<V>> {
        ...
        public Set<K> createKeySet() {
            return new KeySet<K, Collection<V>>() {
                public boolean removeAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Maps.keyPredicateOnEntries(Predicates.m87in(collection)));
                }

                public boolean retainAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.m87in(collection))));
                }
        ...
        public Set<Entry<K, Collection<V>>> createEntrySet() {
            return new EntrySet<K, Collection<V>>() {
                ...
                public boolean removeAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Predicates.m87in(collection));
                }

                public boolean retainAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Predicates.not(Predicates.m87in(collection)));
                }
        ...
        public Collection<Collection<V>> createValues() {
            return new Values<K, Collection<V>>() {
                ...
                public boolean removeAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Maps.valuePredicateOnEntries(Predicates.m87in(collection)));
                }

                public boolean retainAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.m87in(collection))));
                }
            };
        }
    }
    ...
    class Keys extends Keys<K, V> {
        ...
        public Set<Multiset.Entry<K>> entrySet() {
            return new EntrySet<K>() {
                ...
                public boolean removeAll(Collection<?> collection) {
                    return removeEntriesIf(Predicates.m87in(collection));
                }

                public boolean retainAll(Collection<?> collection) {
                    return removeEntriesIf(Predicates.not(Predicates.m87in(collection)));
                }
            };
        }
    }
