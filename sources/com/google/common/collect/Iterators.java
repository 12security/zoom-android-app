...
public final class Iterators {
    ...
    private static class ConcatenatedIterator<T> extends MultitransformedIterator<Iterator<? extends T>, T> {
        ...
        public static <T> Iterator<Iterator<? extends T>> getComponentIterators(Iterator<? extends Iterator<? extends T>> it) {
            return new MultitransformedIterator<Iterator<? extends T>, Iterator<? extends T>>(it) {
                /* access modifiers changed from: 0000 */
                public Iterator<? extends Iterator<? extends T>> transform(Iterator<? extends T> it) {
                    if (it instanceof ConcatenatedIterator) {
                        return ConcatenatedIterator.getComponentIterators(((ConcatenatedIterator) it).backingIterator);
                    }
    ...
    public static boolean removeAll(Iterator<?> it, Collection<?> collection) {
        return removeIf(it, Predicates.m87in(collection));
    }
    ...
    public static boolean retainAll(Iterator<?> it, Collection<?> collection) {
        return removeIf(it, Predicates.not(Predicates.m87in(collection)));
    }
    ...
    public static <T> T[] toArray(Iterator<? extends T> it, Class<T> cls) {
        return Iterables.toArray((Iterable<? extends T>) Lists.newArrayList(it), cls);
    }
    ...
    public static <T> Optional<T> tryFind(Iterator<T> it, Predicate<? super T> predicate) {
        ...
        return filter.hasNext() ? Optional.m83of(filter.next()) : Optional.absent();
    }
