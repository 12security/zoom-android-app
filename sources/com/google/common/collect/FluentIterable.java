...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    private Iterable<E> getDelegate() {
        return (Iterable) this.iterableDelegate.mo29274or(this);
    }
    ...
    public static <T> FluentIterable<T> concat(Iterable<? extends T> iterable, Iterable<? extends T> iterable2) {
        return concat((Iterable<? extends Iterable<? extends T>>) ImmutableList.m115of(iterable, iterable2));
    }
    ...
    public static <T> FluentIterable<T> concat(Iterable<? extends T> iterable, Iterable<? extends T> iterable2, Iterable<? extends T> iterable3) {
        return concat((Iterable<? extends Iterable<? extends T>>) ImmutableList.m116of(iterable, iterable2, iterable3));
    }
    ...
    public static <T> FluentIterable<T> concat(Iterable<? extends T> iterable, Iterable<? extends T> iterable2, Iterable<? extends T> iterable3, Iterable<? extends T> iterable4) {
        return concat((Iterable<? extends Iterable<? extends T>>) ImmutableList.m117of(iterable, iterable2, iterable3, iterable4));
    }
    ...
    @Beta
    /* renamed from: of */
    public static <E> FluentIterable<E> m102of() {
        return from((Iterable<E>) ImmutableList.m113of());
    }

    @Deprecated
    @Beta
    /* renamed from: of */
    public static <E> FluentIterable<E> m104of(E[] eArr) {
        return from((Iterable<E>) Lists.newArrayList(eArr));
    }

    @Beta
    /* renamed from: of */
    public static <E> FluentIterable<E> m103of(@Nullable E e, E... eArr) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m83of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m83of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m83of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
        return Optional.m83of(next);
    }
