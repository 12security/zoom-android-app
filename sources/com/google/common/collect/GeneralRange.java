...
final class GeneralRange<T> implements Serializable {
    ...
    public GeneralRange<T> intersect(GeneralRange<T> generalRange) {
        ...
        if (!hasLowerBound()) {
            boolean z4 = generalRange.hasLowerBound;
        ...
        if (!hasUpperBound()) {
            boolean z6 = generalRange.hasUpperBound;
            Object upperEndpoint3 = generalRange.getUpperEndpoint();
            ...
            if (generalRange.hasUpperBound()) {
                ...
                if (compare2 > 0 || (compare2 == 0 && generalRange.getUpperBoundType() == BoundType.OPEN)) {
                    Object upperEndpoint4 = generalRange.getUpperEndpoint();
                    upperBoundType2 = generalRange.getUpperBoundType();
                    z2 = z5;
                    obj = upperEndpoint4;
                }
        ...
        if (z && z2) {
            int compare3 = this.comparator.compare(lowerEndpoint2, obj);
            if (compare3 > 0 || (compare3 == 0 && lowerBoundType2 == BoundType.OPEN && upperBoundType2 == BoundType.OPEN)) {
                ...
                obj2 = obj;
                GeneralRange generalRange2 = new GeneralRange(this.comparator, z, obj2, boundType2, z2, obj, boundType);
        ...
        obj2 = lowerEndpoint2;
        GeneralRange generalRange22 = new GeneralRange(this.comparator, z, obj2, boundType2, z2, obj, boundType);
