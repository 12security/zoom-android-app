...
public final class Component<T> {
    ...
    public static class Builder<T> {
        ...
        public Component<T> build() {
            ...
            Component component = new Component(new HashSet(this.providedInterfaces), new HashSet(this.dependencies), this.instantiation, this.type, this.factory, this.publishedEvents);
            return component;
        }
    }
    ...
    @Deprecated
    /* renamed from: of */
    public static <T> Component<T> m228of(Class<T> cls, T t) {
    ...
    @SafeVarargs
    /* renamed from: of */
    public static <T> Component<T> m229of(T t, Class<T> cls, Class<? super T>... clsArr) {
