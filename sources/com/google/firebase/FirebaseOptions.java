...
public final class FirebaseOptions {
    ...
    public static final class Builder {
        ...
        public FirebaseOptions build() {
            FirebaseOptions firebaseOptions = new FirebaseOptions(this.applicationId, this.apiKey, this.databaseUrl, this.gaTrackingId, this.gcmSenderId, this.storageBucket, this.projectId);
