...
public final class zza {
    ...
    public final zzc zzf(Bundle bundle) {
        ...
        Builder builder = new Builder(this.zzag, zzm(zza(bundle, "gcm.n.android_channel_id")));
        ...
        builder.setSmallIcon(zzk(zza(bundle, "gcm.n.icon")));
        ...
        if (intent == null) {
            ...
            pendingIntent = PendingIntent.getActivity(this.zzag, zzdt.incrementAndGet(), intent, Ints.MAX_POWER_OF_TWO);
            if (zzk(bundle)) {
