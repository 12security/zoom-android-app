...
final class zzac implements ServiceConnection {
    ...
    private zzac(zzab zzab) {
        this.zzci = zzab;
        this.state = 0;
        this.zzce = new Messenger(new zze(Looper.getMainLooper(), new zzaf(this)));
    ...
    public final synchronized boolean zzb(com.google.firebase.iid.zzal r6) {
        /*
            r5 = this;
            monitor-enter(r5)
        ...
        L_0x000b:
            ...
            return r1
        L_0x000d:
            java.util.Queue<com.google.firebase.iid.zzal<?>> r0 = r5.zzcg     // Catch:{ all -> 0x008e }
        ...
        L_0x003d:
            ...
            com.google.firebase.iid.zzab r3 = r5.zzci     // Catch:{ all -> 0x008e }
            android.content.Context r3 = r3.zzag     // Catch:{ all -> 0x008e }
            ...
            goto L_0x0073
        L_0x0061:
            com.google.firebase.iid.zzab r6 = r5.zzci     // Catch:{ all -> 0x008e }
            java.util.concurrent.ScheduledExecutorService r6 = r6.zzcb     // Catch:{ all -> 0x008e }
        ...
        L_0x008e:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.iid.zzac.zzb(com.google.firebase.iid.zzal):boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x005f, code lost:
        r1.zza(new com.google.firebase.iid.zzak(4, "Not supported by GmsCore"));
     */
    ...
    public final boolean zza(android.os.Message r5) {
        ...
        L_0x0023:
            monitor-enter(r4)
            android.util.SparseArray<com.google.firebase.iid.zzal<?>> r1 = r4.zzch     // Catch:{ all -> 0x006f }
            java.lang.Object r1 = r1.get(r0)     // Catch:{ all -> 0x006f }
            com.google.firebase.iid.zzal r1 = (com.google.firebase.iid.zzal) r1     // Catch:{ all -> 0x006f }
            r2 = 1
            ...
            return r2
        L_0x0049:
            android.util.SparseArray<com.google.firebase.iid.zzal<?>> r3 = r4.zzch     // Catch:{ all -> 0x006f }
    ...
    private final void zzy() {
        this.zzci.zzcb.execute(new zzah(this));
    }
    ...
    public final synchronized void zza(int i, String str) {
        ...
        switch (this.state) {
            ...
            case 2:
                ...
                for (zzal zza : this.zzcg) {
                    zza.zza(zzak);
                }
                this.zzcg.clear();
                for (int i2 = 0; i2 < this.zzch.size(); i2++) {
                    ((zzal) this.zzch.valueAt(i2)).zza(zzak);
                }
                this.zzch.clear();
                return;
            case 3:
    ...
    public final synchronized void zza(int i) {
        zzal zzal = (zzal) this.zzch.get(i);
        if (zzal != null) {
            ...
            this.zzch.remove(i);
            zzal.zza(new zzak(3, "Timed out waiting for response"));
            zzz();
        }
    }
}
