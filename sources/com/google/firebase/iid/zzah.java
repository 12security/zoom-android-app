...
final /* synthetic */ class zzah implements Runnable {
    ...
    public final void run() {
        /*
            r8 = this;
            com.google.firebase.iid.zzac r0 = r8.zzcj
        L_0x0002:
            monitor-enter(r0)
            ...
            return
        L_0x000a:
            java.util.Queue<com.google.firebase.iid.zzal<?>> r1 = r0.zzcg     // Catch:{ all -> 0x00ae }
        ...
        L_0x0017:
            ...
            com.google.firebase.iid.zzal r1 = (com.google.firebase.iid.zzal) r1     // Catch:{ all -> 0x00ae }
            android.util.SparseArray<com.google.firebase.iid.zzal<?>> r3 = r0.zzch     // Catch:{ all -> 0x00ae }
            int r4 = r1.zzcm     // Catch:{ all -> 0x00ae }
            r3.put(r4, r1)     // Catch:{ all -> 0x00ae }
            com.google.firebase.iid.zzab r3 = r0.zzci     // Catch:{ all -> 0x00ae }
            java.util.concurrent.ScheduledExecutorService r3 = r3.zzcb     // Catch:{ all -> 0x00ae }
            com.google.firebase.iid.zzag r4 = new com.google.firebase.iid.zzag     // Catch:{ all -> 0x00ae }
        ...
        L_0x0066:
            com.google.firebase.iid.zzab r3 = r0.zzci
            android.content.Context r3 = r3.zzag
            android.os.Messenger r4 = r0.zzce
            ...
            android.os.Bundle r1 = r1.zzco
            r4.putBundle(r3, r1)
            r5.setData(r4)
            com.google.firebase.iid.zzaj r1 = r0.zzcf     // Catch:{ RemoteException -> 0x00a4 }
