...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        public ParseResult parse(HttpUrl httpUrl, String str) {
            ...
            char c = TextCommandHelper.CHANNEL_CMD_CHAR;
            ...
            if (delimiterOffset3 < skipTrailingAsciiWhitespace && str2.charAt(delimiterOffset3) == '?') {
                int delimiterOffset4 = Util.delimiterOffset(str2, delimiterOffset3, skipTrailingAsciiWhitespace, (char) TextCommandHelper.CHANNEL_CMD_CHAR);
    ...
    public String encodedQuery() {
        ...
        String str = this.url;
        return this.url.substring(indexOf, Util.delimiterOffset(str, indexOf + 1, str.length(), (char) TextCommandHelper.CHANNEL_CMD_CHAR));
    }
            ...
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z3) {
                    ...
                    while (!buffer2.exhausted()) {
                        ...
                        buffer.writeByte((int) HEX_DIGITS[readByte & Ascii.f228SI]);
                    }
                } else {
                    buffer.writeUtf8CodePoint(codePointAt);
                }
