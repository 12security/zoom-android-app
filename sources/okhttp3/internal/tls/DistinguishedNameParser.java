...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f472dn;
    private int end;
    private final int length = this.f472dn.length();
    private int pos;

    public DistinguishedNameParser(X500Principal x500Principal) {
        this.f472dn = x500Principal.getName("RFC2253");
    }
            ...
            while (true) {
                ...
                if (cArr[i2] == '+' || cArr[i2] == ',' || cArr[i2] == ';') {
                    ...
                    if (cArr[i2] >= 'A' && cArr[i2] <= 'F') {
                        cArr[i2] = (char) (cArr[i2] + TokenParser.f498SP);
                    }
                    this.pos++;
                }
            }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f472dn.toCharArray();
