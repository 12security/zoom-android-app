...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random2) {
        if ("GET".equals(request.method())) {
            ...
            this.key = ByteString.m271of(bArr).base64();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x0059, code lost:
        if ((r5 instanceof okhttp3.internal.p017ws.RealWebSocket.Message) == false) goto L_0x0087;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x005b, code lost:
        r1 = ((okhttp3.internal.p017ws.RealWebSocket.Message) r5).data;
        r0 = okio.Okio.buffer(r0.newMessageSink(((okhttp3.internal.p017ws.RealWebSocket.Message) r5).formatOpcode, (long) r1.size()));
        r0.write(r1);
        r0.close();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0089, code lost:
        if ((r5 instanceof okhttp3.internal.p017ws.RealWebSocket.Close) == false) goto L_0x00a0;
     */
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x0008:
            ...
            boolean r6 = r5 instanceof okhttp3.internal.p017ws.RealWebSocket.Close     // Catch:{ all -> 0x00ab }
        ...
        L_0x0031:
            ...
            r8 = r5
            okhttp3.internal.ws.RealWebSocket$Close r8 = (okhttp3.internal.p017ws.RealWebSocket.Close) r8     // Catch:{ all -> 0x00ab }
        ...
        L_0x0050:
            ...
            goto L_0x009b
        L_0x0057:
            boolean r2 = r5 instanceof okhttp3.internal.p017ws.RealWebSocket.Message     // Catch:{ all -> 0x00a6 }
            if (r2 == 0) goto L_0x0087
            r1 = r5
            okhttp3.internal.ws.RealWebSocket$Message r1 = (okhttp3.internal.p017ws.RealWebSocket.Message) r1     // Catch:{ all -> 0x00a6 }
            okio.ByteString r1 = r1.data     // Catch:{ all -> 0x00a6 }
            okhttp3.internal.ws.RealWebSocket$Message r5 = (okhttp3.internal.p017ws.RealWebSocket.Message) r5     // Catch:{ all -> 0x00a6 }
        ...
        L_0x0087:
            boolean r2 = r5 instanceof okhttp3.internal.p017ws.RealWebSocket.Close     // Catch:{ all -> 0x00a6 }
            if (r2 == 0) goto L_0x00a0
            okhttp3.internal.ws.RealWebSocket$Close r5 = (okhttp3.internal.p017ws.RealWebSocket.Close) r5     // Catch:{ all -> 0x00a6 }
    ...
    public void writePingFrame() {
        ...
        L_0x0016:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p017ws.RealWebSocket.writePingFrame():void");
    }
