...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        ...
        public void run() {
            ...
            L_0x0045:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.cache.DiskLruCache.C43091.run():void");
        }
    };
    boolean closed;
        ...
        public Sink newSink(int i) {
            synchronized (DiskLruCache.this) {
                if (this.done) {
                    ...
                    try {
                        C43121 r1 = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[i])) {
    ...
    public synchronized okhttp3.internal.cache.DiskLruCache.Editor edit(java.lang.String r5, long r6) throws java.io.IOException {
        /*
            ...
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r0 = r4.lruEntries     // Catch:{ all -> 0x0074 }
        ...
        L_0x0023:
            ...
            okhttp3.internal.cache.DiskLruCache$Editor r6 = r0.currentEditor     // Catch:{ all -> 0x0074 }
            if (r6 == 0) goto L_0x002b
            monitor-exit(r4)
            return r3
        L_0x002b:
            boolean r6 = r4.mostRecentTrimFailed     // Catch:{ all -> 0x0074 }
            if (r6 != 0) goto L_0x006b
            boolean r6 = r4.mostRecentRebuildFailed     // Catch:{ all -> 0x0074 }
            if (r6 == 0) goto L_0x0034
            goto L_0x006b
        L_0x0034:
            okio.BufferedSink r6 = r4.journalWriter     // Catch:{ all -> 0x0074 }
            ...
            okio.BufferedSink r6 = r6.writeUtf8(r5)     // Catch:{ all -> 0x0074 }
            r7 = 10
            r6.writeByte(r7)     // Catch:{ all -> 0x0074 }
            okio.BufferedSink r6 = r4.journalWriter     // Catch:{ all -> 0x0074 }
            r6.flush()     // Catch:{ all -> 0x0074 }
            boolean r6 = r4.hasJournalErrors     // Catch:{ all -> 0x0074 }
        ...
        L_0x0056:
            ...
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r6 = r4.lruEntries     // Catch:{ all -> 0x0074 }
            r6.put(r5, r0)     // Catch:{ all -> 0x0074 }
        L_0x0062:
            okhttp3.internal.cache.DiskLruCache$Editor r5 = new okhttp3.internal.cache.DiskLruCache$Editor     // Catch:{ all -> 0x0074 }
            r5.<init>(r0)     // Catch:{ all -> 0x0074 }
            r0.currentEditor = r5     // Catch:{ all -> 0x0074 }
            monitor-exit(r4)
            return r5
        L_0x006b:
            java.util.concurrent.Executor r5 = r4.executor     // Catch:{ all -> 0x0074 }
            java.lang.Runnable r6 = r4.cleanupRunnable     // Catch:{ all -> 0x0074 }
