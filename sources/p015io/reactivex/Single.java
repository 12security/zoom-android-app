...
import p015io.reactivex.internal.observers.BiConsumerSingleObserver;
import p015io.reactivex.internal.observers.BlockingMultiObserver;
import p015io.reactivex.internal.observers.ConsumerSingleObserver;
import p015io.reactivex.internal.observers.FutureSingleObserver;
import p015io.reactivex.internal.operators.completable.CompletableFromSingle;
import p015io.reactivex.internal.operators.completable.CompletableToFlowable;
...
import p015io.reactivex.internal.operators.maybe.MaybeFilterSingle;
import p015io.reactivex.internal.operators.maybe.MaybeFromSingle;
import p015io.reactivex.internal.operators.mixed.SingleFlatMapObservable;
...
import p015io.reactivex.internal.operators.single.SingleAmb;
import p015io.reactivex.internal.operators.single.SingleCache;
import p015io.reactivex.internal.operators.single.SingleContains;
import p015io.reactivex.internal.operators.single.SingleCreate;
import p015io.reactivex.internal.operators.single.SingleDefer;
import p015io.reactivex.internal.operators.single.SingleDelay;
import p015io.reactivex.internal.operators.single.SingleDelayWithCompletable;
import p015io.reactivex.internal.operators.single.SingleDelayWithObservable;
import p015io.reactivex.internal.operators.single.SingleDelayWithPublisher;
import p015io.reactivex.internal.operators.single.SingleDelayWithSingle;
import p015io.reactivex.internal.operators.single.SingleDematerialize;
import p015io.reactivex.internal.operators.single.SingleDetach;
import p015io.reactivex.internal.operators.single.SingleDoAfterSuccess;
import p015io.reactivex.internal.operators.single.SingleDoAfterTerminate;
import p015io.reactivex.internal.operators.single.SingleDoFinally;
import p015io.reactivex.internal.operators.single.SingleDoOnDispose;
import p015io.reactivex.internal.operators.single.SingleDoOnError;
import p015io.reactivex.internal.operators.single.SingleDoOnEvent;
import p015io.reactivex.internal.operators.single.SingleDoOnSubscribe;
import p015io.reactivex.internal.operators.single.SingleDoOnSuccess;
import p015io.reactivex.internal.operators.single.SingleEquals;
import p015io.reactivex.internal.operators.single.SingleError;
import p015io.reactivex.internal.operators.single.SingleFlatMap;
import p015io.reactivex.internal.operators.single.SingleFlatMapCompletable;
import p015io.reactivex.internal.operators.single.SingleFlatMapIterableFlowable;
import p015io.reactivex.internal.operators.single.SingleFlatMapIterableObservable;
import p015io.reactivex.internal.operators.single.SingleFlatMapMaybe;
import p015io.reactivex.internal.operators.single.SingleFlatMapPublisher;
import p015io.reactivex.internal.operators.single.SingleFromCallable;
import p015io.reactivex.internal.operators.single.SingleFromPublisher;
import p015io.reactivex.internal.operators.single.SingleFromUnsafeSource;
import p015io.reactivex.internal.operators.single.SingleHide;
import p015io.reactivex.internal.operators.single.SingleInternalHelper;
import p015io.reactivex.internal.operators.single.SingleJust;
import p015io.reactivex.internal.operators.single.SingleLift;
import p015io.reactivex.internal.operators.single.SingleMap;
import p015io.reactivex.internal.operators.single.SingleMaterialize;
import p015io.reactivex.internal.operators.single.SingleNever;
import p015io.reactivex.internal.operators.single.SingleObserveOn;
import p015io.reactivex.internal.operators.single.SingleOnErrorReturn;
import p015io.reactivex.internal.operators.single.SingleResumeNext;
import p015io.reactivex.internal.operators.single.SingleSubscribeOn;
import p015io.reactivex.internal.operators.single.SingleTakeUntil;
import p015io.reactivex.internal.operators.single.SingleTimeout;
import p015io.reactivex.internal.operators.single.SingleTimer;
import p015io.reactivex.internal.operators.single.SingleToFlowable;
import p015io.reactivex.internal.operators.single.SingleToObservable;
import p015io.reactivex.internal.operators.single.SingleUnsubscribeOn;
import p015io.reactivex.internal.operators.single.SingleUsing;
import p015io.reactivex.internal.operators.single.SingleZipArray;
import p015io.reactivex.internal.operators.single.SingleZipIterable;
...
public abstract class Single<T> implements SingleSource<T> {
    ...
    @SchedulerSupport("none")
    /* renamed from: as */
    public final <R> R mo56099as(@NonNull SingleConverter<T, ? extends R> singleConverter) {
    ...
    @SchedulerSupport("none")
    /* renamed from: to */
    public final <R> R mo56173to(Function<? super Single<T>, R> function) {
        try {
