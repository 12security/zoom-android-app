...
public final class SingleDelay<T> extends Single<T> {
    ...
    final class Delay implements SingleObserver<T> {
        ...
        final class OnError implements Runnable {
            ...
            public void run() {
                Delay.this.downstream.onError(this.f439e);
            }
        }
        ...
        public void onSubscribe(Disposable disposable) {
            this.f438sd.replace(disposable);
        }

        public void onSuccess(T t) {
            this.f438sd.replace(SingleDelay.this.scheduler.scheduleDirect(new OnSuccess(t), SingleDelay.this.time, SingleDelay.this.unit));
        }

        public void onError(Throwable th) {
            this.f438sd.replace(SingleDelay.this.scheduler.scheduleDirect(new OnError(th), SingleDelay.this.delayError ? SingleDelay.this.time : 0, SingleDelay.this.unit));
        }
    }
