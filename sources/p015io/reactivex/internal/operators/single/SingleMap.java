...
public final class SingleMap<T, R> extends Single<R> {
    ...
    static final class MapSingleObserver<T, R> implements SingleObserver<T> {
        ...
        /* renamed from: t */
        final SingleObserver<? super R> f442t;

        MapSingleObserver(SingleObserver<? super R> singleObserver, Function<? super T, ? extends R> function) {
            this.f442t = singleObserver;
            this.mapper = function;
        }

        public void onSubscribe(Disposable disposable) {
            this.f442t.onSubscribe(disposable);
        }

        public void onSuccess(T t) {
            try {
                this.f442t.onSuccess(ObjectHelper.requireNonNull(this.mapper.apply(t), "The mapper function returned a null value."));
            } catch (Throwable th) {
