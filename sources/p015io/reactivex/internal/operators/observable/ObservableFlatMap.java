            ...
            while (!checkTerminate()) {
                ...
                if (!z || !((simplePlainQueue2 == null || simplePlainQueue2.isEmpty()) && length == 0 && i == 0)) {
                    if (length != 0) {
                        ...
                        if (length <= i5 || innerObserverArr[i5].f420id != j) {
                            if (length <= i5) {
                                i5 = 0;
                            }
                            int i6 = i5;
                            for (int i7 = 0; i7 < length && innerObserverArr[i6].f420id != j; i7++) {
                                i6++;
                                if (i6 == length) {
                                    i6 = 0;
                                }
                            ...
                            this.lastIndex = i6;
                            this.lastId = innerObserverArr[i6].f420id;
                            i5 = i6;
                        }
                        int i8 = 0;
                        i2 = 0;
                        ...
                        this.lastIndex = i3;
                        this.lastId = innerObserverArr[i3].f420id;
                    } else {
                        i2 = 0;
                    }
                    if (i2 == 0) {
