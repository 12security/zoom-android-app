        ...
        public void drain() {
            if (getAndIncrement() == 0) {
                ...
                while (!this.cancelled) {
                    ...
                    if (this.f428v1 == null) {
                        this.f428v1 = spscLinkedArrayQueue.poll();
                    }
                    boolean z3 = this.f428v1 == null;
                    if (this.f429v2 == null) {
                        this.f429v2 = spscLinkedArrayQueue2.poll();
                    }
                    boolean z4 = this.f429v2 == null;
                    if (z && z2 && z3 && z4) {
                        ...
                        if (!z3 && !z4) {
                            try {
                                if (!this.comparer.test(this.f428v1, this.f429v2)) {
                                    cancel(spscLinkedArrayQueue, spscLinkedArrayQueue2);
