...
public final class ObservableRefCount<T> extends Observable<T> {
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        synchronized (this) {
            ...
            z = true;
            if (refConnection.connected || j2 != ((long) this.f423n)) {
                z = false;
            } else {
    ...
    public void cancel(p015io.reactivex.internal.operators.observable.ObservableRefCount.RefConnection r6) {
        /*
            r5 = this;
            monitor-enter(r5)
        ...
        L_0x0041:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: p015io.reactivex.internal.operators.observable.ObservableRefCount.cancel(io.reactivex.internal.operators.observable.ObservableRefCount$RefConnection):void");
    }
