        ...
        public void drain() {
            if (getAndIncrement() == 0) {
                ...
                while (!this.cancelled) {
                    ...
                    if (this.f426v1 == null) {
                        this.f426v1 = spscLinkedArrayQueue.poll();
                    }
                    boolean z3 = this.f426v1 == null;
                    if (this.f427v2 == null) {
                        this.f427v2 = spscLinkedArrayQueue2.poll();
                    }
                    boolean z4 = this.f427v2 == null;
                    if (z && z2 && z3 && z4) {
                        ...
                        if (!z3 && !z4) {
                            try {
                                if (!this.comparer.test(this.f426v1, this.f427v2)) {
                                    cancel(spscLinkedArrayQueue, spscLinkedArrayQueue2);
