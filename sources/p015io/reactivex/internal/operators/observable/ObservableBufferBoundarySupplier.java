...
public final class ObservableBufferBoundarySupplier<T, U extends Collection<? super T>, B> extends AbstractObservableWithUpstream<T, U> {
    ...
    static final class BufferBoundarySupplierObserver<T, U extends Collection<? super T>, B> extends QueueDrainObserver<T, U, U> implements Observer<T>, Disposable {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:10:0x0019, code lost:
            p015io.reactivex.internal.util.QueueDrainHelper.drainLoop(r3.queue, r3.downstream, false, r3, r3);
         */
        ...
        public void onComplete() {
            ...
            L_0x0007:
                ...
                r2 = 0
                p015io.reactivex.internal.util.QueueDrainHelper.drainLoop(r0, r1, r2, r3, r3)
            L_0x0021:
                return
            L_0x0022:
                r0 = move-exception
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p015io.reactivex.internal.operators.observable.ObservableBufferBoundarySupplier.BufferBoundarySupplierObserver.onComplete():void");
        }
        ...
        public void next() {
            /*
                ...
                java.lang.Object r0 = p015io.reactivex.internal.functions.ObjectHelper.requireNonNull(r0, r1)     // Catch:{ Throwable -> 0x0051 }
                java.util.Collection r0 = (java.util.Collection) r0     // Catch:{ Throwable -> 0x0051 }
                java.util.concurrent.Callable<? extends io.reactivex.ObservableSource<B>> r1 = r4.boundarySupplier     // Catch:{ Throwable -> 0x003f }
                java.lang.Object r1 = r1.call()     // Catch:{ Throwable -> 0x003f }
                java.lang.String r2 = "The boundary ObservableSource supplied is null"
                java.lang.Object r1 = p015io.reactivex.internal.functions.ObjectHelper.requireNonNull(r1, r2)     // Catch:{ Throwable -> 0x003f }
                io.reactivex.ObservableSource r1 = (p015io.reactivex.ObservableSource) r1     // Catch:{ Throwable -> 0x003f }
                ...
                boolean r3 = p015io.reactivex.internal.disposables.DisposableHelper.replace(r3, r2)
            ...
            L_0x0051:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p015io.reactivex.internal.operators.observable.ObservableBufferBoundarySupplier.BufferBoundarySupplierObserver.next():void");
        }
