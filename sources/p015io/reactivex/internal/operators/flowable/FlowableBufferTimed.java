...
import p015io.reactivex.internal.util.QueueDrainHelper;
...
public final class FlowableBufferTimed<T, U extends Collection<? super T>> extends AbstractFlowableWithUpstream<T, U> {
    ...
    static final class BufferExactBoundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Subscription, Runnable, Disposable {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:17:?, code lost:
            r8 = (java.util.Collection) p015io.reactivex.internal.functions.ObjectHelper.requireNonNull(r7.bufferSupplier.call(), "The supplied buffer is null");
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:23:0x0045, code lost:
            if (r7.restartTimerOnMaxSize == false) goto L_0x0055;
         */
        ...
        public void onNext(T r8) {
            ...
            L_0x0028:
                ...
                java.lang.Object r8 = p015io.reactivex.internal.functions.ObjectHelper.requireNonNull(r8, r0)     // Catch:{ Throwable -> 0x0059 }
                ...
                io.reactivex.Scheduler$Worker r0 = r7.f380w
                long r4 = r7.timespan
            ...
            L_0x0066:
                ...
                throw r8
            */
            throw new UnsupportedOperationException("Method not decompiled: p015io.reactivex.internal.operators.flowable.FlowableBufferTimed.BufferExactBoundedSubscriber.onNext(java.lang.Object):void");
        }
    ...
    static final class BufferExactUnboundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Subscription, Runnable, Disposable {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x001e, code lost:
            p015io.reactivex.internal.util.QueueDrainHelper.drainMaxLoop(r4.queue, r4.downstream, false, null, r4);
         */
        ...
        public void onComplete() {
            /*
                ...
                p015io.reactivex.internal.disposables.DisposableHelper.dispose(r0)
                monitor-enter(r4)
            ...
            L_0x000c:
                ...
                r3 = 0
                p015io.reactivex.internal.util.QueueDrainHelper.drainMaxLoop(r0, r2, r3, r1, r4)
            L_0x0026:
                return
            L_0x0027:
                r0 = move-exception
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p015io.reactivex.internal.operators.flowable.FlowableBufferTimed.BufferExactUnboundedSubscriber.onComplete():void");
        }
    ...
    static final class BufferSkipBoundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Subscription, Runnable {
        ...
        final class RemoveFromBuffer implements Runnable {
            ...
            public void run() {
                ...
                bufferSkipBoundedSubscriber.fastPathOrderedEmitMax(this.buffer, false, bufferSkipBoundedSubscriber.f381w);
            }
        }
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.upstream, subscription)) {
                ...
                try {
                    ...
                    this.downstream.onSubscribe(this);
                    subscription.request(Long.MAX_VALUE);
                    Worker worker = this.f381w;
                    long j = this.timeskip;
                    worker.schedulePeriodically(this, j, j, this.unit);
                    this.f381w.schedule(new RemoveFromBuffer(collection), this.timespan, this.unit);
                } catch (Throwable th) {
                    Exceptions.throwIfFatal(th);
                    this.f381w.dispose();
                    subscription.cancel();
        ...
        public void onComplete() {
            ...
            this.done = true;
            if (enter()) {
                QueueDrainHelper.drainMaxLoop(this.queue, this.downstream, false, this.f381w, this);
            }
        }
