...
public final class ObservableConcatMapSingle<T, R> extends Observable<R> {
    ...
    public ObservableConcatMapSingle(Observable<T> observable, Function<? super T, ? extends SingleSource<? extends R>> function, ErrorMode errorMode2, int i) {
    ...
    public void subscribeActual(Observer<? super R> observer) {
        if (!ScalarXMapZHelper.tryAsSingle(this.source, this.mapper, observer)) {
            this.source.subscribe((Observer<? super T>) new ConcatMapSingleMainObserver<Object>(observer, this.mapper, this.prefetch, this.errorMode));
        }
    }
}
