    ...
    static final class ParallelDoOnNextConditionalSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public boolean tryOnNext(T r8) {
            ...
            L_0x0014:
                ...
                java.lang.Object r4 = p015io.reactivex.internal.functions.ObjectHelper.requireNonNull(r4, r5)     // Catch:{ Throwable -> 0x0047 }
                io.reactivex.parallel.ParallelFailureHandling r4 = (p015io.reactivex.parallel.ParallelFailureHandling) r4     // Catch:{ Throwable -> 0x0047 }
                int[] r5 = p015io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C42791.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r4 = r4.ordinal()
                r4 = r5[r4]
                switch(r4) {
            ...
            L_0x0047:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p015io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.ParallelDoOnNextConditionalSubscriber.tryOnNext(java.lang.Object):boolean");
        }
    ...
    static final class ParallelDoOnNextSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public boolean tryOnNext(T r9) {
            ...
            L_0x0014:
                ...
                java.lang.Object r5 = p015io.reactivex.internal.functions.ObjectHelper.requireNonNull(r5, r6)     // Catch:{ Throwable -> 0x0047 }
                io.reactivex.parallel.ParallelFailureHandling r5 = (p015io.reactivex.parallel.ParallelFailureHandling) r5     // Catch:{ Throwable -> 0x0047 }
                int[] r0 = p015io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C42791.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r5 = r5.ordinal()
                r0 = r0[r5]
                switch(r0) {
                    case 1: goto L_0x0008;
            ...
            L_0x0047:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p015io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.ParallelDoOnNextSubscriber.tryOnNext(java.lang.Object):boolean");
        }
