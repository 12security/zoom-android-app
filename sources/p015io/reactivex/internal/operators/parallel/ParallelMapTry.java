...
import p015io.reactivex.parallel.ParallelFailureHandling;
    ...
    static final class ParallelMapTryConditionalSubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public boolean tryOnNext(T r8) {
            ...
            L_0x0008:
                ...
                java.lang.Object r8 = p015io.reactivex.internal.functions.ObjectHelper.requireNonNull(r0, r4)     // Catch:{ Throwable -> 0x001b }
            ...
            L_0x001b:
                ...
                java.lang.Object r4 = p015io.reactivex.internal.functions.ObjectHelper.requireNonNull(r4, r5)     // Catch:{ Throwable -> 0x004e }
                io.reactivex.parallel.ParallelFailureHandling r4 = (p015io.reactivex.parallel.ParallelFailureHandling) r4     // Catch:{ Throwable -> 0x004e }
                int[] r5 = p015io.reactivex.internal.operators.parallel.ParallelMapTry.C42811.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r4 = r4.ordinal()
                r4 = r5[r4]
                switch(r4) {
            ...
            L_0x004e:
                r8 = move-exception
                p015io.reactivex.exceptions.Exceptions.throwIfFatal(r8)
                r7.cancel()
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p015io.reactivex.internal.operators.parallel.ParallelMapTry.ParallelMapTryConditionalSubscriber.tryOnNext(java.lang.Object):boolean");
        }
    ...
    static final class ParallelMapTrySubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public boolean tryOnNext(T r9) {
            ...
            L_0x0008:
                ...
                java.lang.Object r9 = p015io.reactivex.internal.functions.ObjectHelper.requireNonNull(r4, r5)     // Catch:{ Throwable -> 0x001b }
                org.reactivestreams.Subscriber<? super R> r1 = r8.downstream
                r1.onNext(r9)
                return r0
            L_0x001b:
                r4 = move-exception
                p015io.reactivex.exceptions.Exceptions.throwIfFatal(r4)
                ...
                java.lang.Object r5 = p015io.reactivex.internal.functions.ObjectHelper.requireNonNull(r5, r6)     // Catch:{ Throwable -> 0x004e }
                io.reactivex.parallel.ParallelFailureHandling r5 = (p015io.reactivex.parallel.ParallelFailureHandling) r5     // Catch:{ Throwable -> 0x004e }
                int[] r0 = p015io.reactivex.internal.operators.parallel.ParallelMapTry.C42811.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r5 = r5.ordinal()
                r0 = r0[r5]
                switch(r0) {
                    case 1: goto L_0x0008;
            ...
            L_0x004e:
                r9 = move-exception
                p015io.reactivex.exceptions.Exceptions.throwIfFatal(r9)
                r8.cancel()
                io.reactivex.exceptions.CompositeException r2 = new io.reactivex.exceptions.CompositeException
                r3 = 2
                java.lang.Throwable[] r3 = new java.lang.Throwable[r3]
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p015io.reactivex.internal.operators.parallel.ParallelMapTry.ParallelMapTrySubscriber.tryOnNext(java.lang.Object):boolean");
        }
