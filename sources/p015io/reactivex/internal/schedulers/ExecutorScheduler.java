...
public final class ExecutorScheduler extends Scheduler {
    ...
    final class DelayedDispose implements Runnable {
        ...
        /* renamed from: dr */
        private final DelayedRunnable f445dr;

        DelayedDispose(DelayedRunnable delayedRunnable) {
            this.f445dr = delayedRunnable;
        }

        public void run() {
            this.f445dr.direct.replace(ExecutorScheduler.this.scheduleDirect(this.f445dr));
        }
    }
    ...
    public static final class ExecutorWorker extends Worker implements Runnable {
        ...
        public Disposable schedule(@NonNull Runnable runnable, long j, @NonNull TimeUnit timeUnit) {
            ...
            if (executor2 instanceof ScheduledExecutorService) {
                try {
                    scheduledRunnable.setFuture(((ScheduledExecutorService) executor2).schedule(scheduledRunnable, j, timeUnit));
                } catch (RejectedExecutionException e) {
                    this.disposed = true;
                    RxJavaPlugins.onError(e);
                    return EmptyDisposable.INSTANCE;
        ...
        public void run() {
            ...
            L_0x0025:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p015io.reactivex.internal.schedulers.ExecutorScheduler.ExecutorWorker.run():void");
        }
    }
    ...
    public Disposable scheduleDirect(@NonNull Runnable runnable) {
        ...
        try {
            if (this.executor instanceof ExecutorService) {
                ...
                InterruptibleRunnable interruptibleRunnable = new InterruptibleRunnable(onSchedule, null);
