...
public class DiffUtil {
    ...
    public static class DiffResult {
        ...
        public int convertOldPositionToNew(@IntRange(from = 0) int i) {
            ...
            sb.append(this.mOldItemStatuses.length);
        ...
        public int convertNewPositionToOld(@IntRange(from = 0) int i) {
            ...
            sb.append(this.mNewItemStatuses.length);
            throw new IndexOutOfBoundsException(sb.toString());
        }
        ...
        public void dispatchUpdatesTo(@NonNull ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                for (int i6 = i3 - 1; i6 >= 0; i6--) {
                    if ((this.mOldItemStatuses[snake.f30x + i6] & 31) == 2) {
                        batchingListUpdateCallback.onChanged(snake.f30x + i6, 1, this.mCallback.getChangePayload(snake.f30x + i6, snake.f31y + i6));
                    }
                }
                i = snake.f30x;
                i2 = snake.f31y;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:41:0x00bc, code lost:
        if (r2[r13 - 1] < r2[r13 + 1]) goto L_0x00c9;
     */
