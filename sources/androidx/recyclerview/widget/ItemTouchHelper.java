...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
            ...
            if (actionMasked == 0) {
                ...
                if (ItemTouchHelper.this.mSelected == null) {
                    ...
                    if (findAnimation != null) {
                        ItemTouchHelper.this.mInitialTouchX -= findAnimation.f33mX;
                        ItemTouchHelper.this.mInitialTouchY -= findAnimation.f34mY;
    ...
    public static abstract class Callback {
        ...
        public void onDraw(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                onChildDraw(canvas, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f33mX, recoverAnimation.f34mY, recoverAnimation.mActionState, false);
        ...
        public void onDrawOver(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                int save = canvas.save();
                onChildDrawOver(canvas, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f33mX, recoverAnimation.f34mY, recoverAnimation.mActionState, false);
                canvas.restoreToCount(save);
            }
            if (viewHolder != null) {
                int save2 = canvas.save();
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        public void update() {
            ...
            if (f == f2) {
                this.f33mX = this.mViewHolder.itemView.getTranslationX();
            } else {
                this.f33mX = f + (this.mFraction * (f2 - f));
            }
            float f3 = this.mStartDy;
            float f4 = this.mTargetY;
            if (f3 == f4) {
                this.f34mY = this.mViewHolder.itemView.getTranslationY();
            } else {
                this.f34mY = f3 + (this.mFraction * (f4 - f3));
            }
        }
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (recyclerView2 != recyclerView) {
            ...
            if (recyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0305R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0305R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
        ...
        if (viewHolder2 != this.mSelected || i3 != this.mActionState) {
            ...
            if (viewHolder3 != null) {
                if (viewHolder3.itemView.getParent() != null) {
                    ...
                    C03273 r0 = new RecoverAnimation(this, viewHolder3, i6, i4, f3, f4, f2, f) {
    ...
    public View findChildView(MotionEvent motionEvent) {
        ...
        for (int size = this.mRecoverAnimations.size() - 1; size >= 0; size--) {
            ...
            if (hitTest(view2, x, y, recoverAnimation.f33mX, recoverAnimation.f34mY)) {
                return view2;
            }
        }
