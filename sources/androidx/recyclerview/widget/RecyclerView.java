...
import androidx.recyclerview.C0305R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        public void offsetChildrenHorizontal(@C0031Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
        ...
        public void offsetChildrenVertical(@C0031Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0305R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0305R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0305R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0305R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0305R.styleable.RecyclerView_stackFromEnd, false);
        ...
        public void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), Ints.MAX_POWER_OF_TWO), MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), Ints.MAX_POWER_OF_TWO));
        }
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(@C0031Px int i, @C0031Px int i2) {
                this(i, i2, Integer.MIN_VALUE, null);
            }

            public Action(@C0031Px int i, @C0031Px int i2, int i3) {
                this(i, i2, i3, null);
            }

            public Action(@C0031Px int i, @C0031Px int i2, int i3, @Nullable Interpolator interpolator) {
            ...
            public void setDx(@C0031Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }
            ...
            public void setDy(@C0031Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@C0031Px int i, @C0031Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
        ...
        /* access modifiers changed from: protected */
        public abstract void onSeekTargetStep(@C0031Px int i, @C0031Px int i2, @NonNull State state, @NonNull Action action);
    ...
    public void onScrolled(@C0031Px int i, @C0031Px int i2) {
    }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0305R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes2.getString(C0305R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0305R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes2.getBoolean(C0305R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes2.getDrawable(C0305R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(C0305R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(C0305R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(C0305R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    public void smoothScrollBy(@C0031Px int i, @C0031Px int i2) {
        smoothScrollBy(i, i2, null);
    }

    public void smoothScrollBy(@C0031Px int i, @C0031Px int i2, @Nullable Interpolator interpolator) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (!this.mLayoutFrozen) {
        ...
        if (layoutManager.isAutoMeasureEnabled()) {
            ...
            if (!z && this.mAdapter != null) {
                ...
                if (this.mLayout.shouldMeasureTwice()) {
                    this.mLayout.setMeasureSpecs(MeasureSpec.makeMeasureSpec(getMeasuredWidth(), Ints.MAX_POWER_OF_TWO), MeasureSpec.makeMeasureSpec(getMeasuredHeight(), Ints.MAX_POWER_OF_TWO));
                    this.mState.mIsMeasuring = true;
                    dispatchLayoutStep2();
                    this.mLayout.setMeasuredDimensionFromChildren(i, i2);
                }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0305R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0305R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0305R.dimen.fastscroll_margin));
    }
