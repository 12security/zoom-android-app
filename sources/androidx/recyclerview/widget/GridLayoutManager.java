    ...
    public void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        for (int i20 = 0; i20 < i16; i20++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i17) {
                ...
                if (this.mOrientation == 1) {
                    i12 = getChildMeasureSpec(spaceForSpanRange, Ints.MAX_POWER_OF_TWO, i22, layoutParams.width, false);
                    i11 = MeasureSpec.makeMeasureSpec(i17 - i21, Ints.MAX_POWER_OF_TWO);
                } else {
                    int makeMeasureSpec = MeasureSpec.makeMeasureSpec(i17 - i22, Ints.MAX_POWER_OF_TWO);
                    i11 = getChildMeasureSpec(spaceForSpanRange, Ints.MAX_POWER_OF_TWO, i21, layoutParams.height, false);
                    i12 = makeMeasureSpec;
                }
