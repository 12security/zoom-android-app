...
public class ViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
        ...
        void onPageScrolled(int i, float f, @C0031Px int i2);
    ...
    public void populate(int r18) {
        ...
        L_0x021e:
            return
        L_0x021f:
            android.content.res.Resources r1 = r17.getResources()     // Catch:{ NotFoundException -> 0x022c }
            int r2 = r17.getId()     // Catch:{ NotFoundException -> 0x022c }
            java.lang.String r1 = r1.getResourceName(r2)     // Catch:{ NotFoundException -> 0x022c }
            goto L_0x0234
        L_0x022c:
            int r1 = r17.getId()
    ...
    public void onMeasure(int i, int i2) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams != null && layoutParams.isDecor) {
                    ...
                    if (z2) {
                        ...
                        i3 = z ? Ints.MAX_POWER_OF_TWO : Integer.MIN_VALUE;
                    }
        ...
        this.mChildWidthMeasureSpec = MeasureSpec.makeMeasureSpec(i7, Ints.MAX_POWER_OF_TWO);
        this.mChildHeightMeasureSpec = MeasureSpec.makeMeasureSpec(i6, Ints.MAX_POWER_OF_TWO);
        this.mInLayout = true;
        populate();
        ...
        for (int i13 = 0; i13 < childCount2; i13++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (layoutParams2 == null || !layoutParams2.isDecor) {
                    childAt2.measure(MeasureSpec.makeMeasureSpec((int) (((float) i7) * layoutParams2.widthFactor), Ints.MAX_POWER_OF_TWO), this.mChildHeightMeasureSpec);
                }
            }
        }
    }
                ...
                if (!layoutParams2.isDecor) {
                    ...
                    if (infoForChild != null) {
                        ...
                        if (layoutParams2.needsMeasure) {
                            ...
                            childAt2.measure(MeasureSpec.makeMeasureSpec((int) (f * layoutParams2.widthFactor), Ints.MAX_POWER_OF_TWO), MeasureSpec.makeMeasureSpec((i8 - i11) - i9, Ints.MAX_POWER_OF_TWO));
                        }
