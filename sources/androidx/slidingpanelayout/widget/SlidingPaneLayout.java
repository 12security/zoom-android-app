...
public class SlidingPaneLayout extends ViewGroup {
    ...
    public void setParallaxDistance(@C0031Px int i) {
        this.mParallaxBy = i;
        requestLayout();
    }
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    i11 = MeasureSpec.makeMeasureSpec(paddingLeft - i16, Ints.MAX_POWER_OF_TWO);
                } else {
                    i11 = MeasureSpec.makeMeasureSpec(layoutParams.width, Ints.MAX_POWER_OF_TWO);
                }
                if (layoutParams.height == -2) {
                    i12 = MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                } else if (layoutParams.height == -1) {
                    i12 = MeasureSpec.makeMeasureSpec(i3, Ints.MAX_POWER_OF_TWO);
                } else {
                    i12 = MeasureSpec.makeMeasureSpec(layoutParams.height, Ints.MAX_POWER_OF_TWO);
                }
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width != 0) {
                                    ...
                                    i8 = MeasureSpec.makeMeasureSpec(i3, Ints.MAX_POWER_OF_TWO);
                                } else {
                                ...
                                if (z2) {
                                    ...
                                    i6 = i17;
                                    int makeMeasureSpec = MeasureSpec.makeMeasureSpec(i19, Ints.MAX_POWER_OF_TWO);
                                    if (i7 != i19) {
                                        childAt2.measure(makeMeasureSpec, i8);
                                    }
                                } else {
                                    i6 = i17;
                                    childAt2.measure(MeasureSpec.makeMeasureSpec(i7 + ((int) ((layoutParams2.weight * ((float) Math.max(0, i14))) / f)), Ints.MAX_POWER_OF_TWO), i8);
                                }
                            } else {
                                i6 = i17;
                            }
                            ...
                            if (!z5) {
                                ...
                                i10 = MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), Ints.MAX_POWER_OF_TWO);
                            } else if (layoutParams2.height == -2) {
                                i10 = MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                                i9 = Ints.MAX_POWER_OF_TWO;
                            } else if (layoutParams2.height == -1) {
                                i9 = Ints.MAX_POWER_OF_TWO;
                                i10 = MeasureSpec.makeMeasureSpec(i3, Ints.MAX_POWER_OF_TWO);
                            } else {
                                i9 = Ints.MAX_POWER_OF_TWO;
                                i10 = MeasureSpec.makeMeasureSpec(layoutParams2.height, Ints.MAX_POWER_OF_TWO);
                            }
