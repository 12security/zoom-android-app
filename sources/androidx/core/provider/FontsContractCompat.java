...
public class FontsContractCompat {
    ...
    public static class FontInfo {
        ...
        @RestrictTo({Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int i, @IntRange(from = 1, mo587to = 1000) int i2, boolean z, int i3) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x008c, code lost:
        sBackgroundThread.postAndReply(r1, new androidx.core.provider.FontsContractCompat.C01593());
     */
    ...
    public static android.graphics.Typeface getFontSync(final android.content.Context r2, final androidx.core.provider.FontRequest r3, @androidx.annotation.Nullable final androidx.core.content.res.ResourcesCompat.FontCallback r4, @androidx.annotation.Nullable final android.os.Handler r5, boolean r6, int r7, final int r8) {
        ...
        L_0x0045:
            ...
            androidx.core.provider.SelfDestructiveThread r3 = sBackgroundThread     // Catch:{ InterruptedException -> 0x0058 }
            java.lang.Object r3 = r3.postAndWait(r1, r7)     // Catch:{ InterruptedException -> 0x0058 }
            androidx.core.provider.FontsContractCompat$TypefaceResult r3 = (androidx.core.provider.FontsContractCompat.TypefaceResult) r3     // Catch:{ InterruptedException -> 0x0058 }
        ...
        L_0x0062:
            ...
            monitor-enter(r4)
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.provider.SelfDestructiveThread$ReplyCallback<androidx.core.provider.FontsContractCompat$TypefaceResult>>> r5 = sPendingReplies     // Catch:{ all -> 0x0097 }
        ...
        L_0x007c:
            ...
            r5.add(r3)     // Catch:{ all -> 0x0097 }
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.provider.SelfDestructiveThread$ReplyCallback<androidx.core.provider.FontsContractCompat$TypefaceResult>>> r3 = sPendingReplies     // Catch:{ all -> 0x0097 }
    ...
    static FontInfo[] getFontFromProvider(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        Uri build2 = new Builder().scheme(Param.CONTENT).authority(str2).appendPath(BoxFile.TYPE).build();
        Cursor cursor2 = null;
        try {
