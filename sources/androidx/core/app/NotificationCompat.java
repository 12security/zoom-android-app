...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            public Action build() {
                ...
                Action action = new Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, remoteInputArr2, remoteInputArr, this.mAllowGeneratedReplies, this.mSemanticAction, this.mShowsUserInterface);
                return action;
            }
        }
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0144R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0144R.dimen.compat_notification_large_icon_max_height);
        ...
        public static class UnreadConversation {
            ...
            public static class Builder {
                ...
                public UnreadConversation build() {
                    ...
                    UnreadConversation unreadConversation = new UnreadConversation((String[]) list.toArray(new String[list.size()]), this.mRemoteInput, this.mReplyPendingIntent, this.mReadPendingIntent, new String[]{this.mParticipant}, this.mLatestTimestamp);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private android.widget.RemoteViews createRemoteViews(android.widget.RemoteViews r7, boolean r8) {
            /*
                r6 = this;
                int r0 = androidx.core.C0144R.layout.notification_template_custom_big
                r1 = 1
                r2 = 0
                android.widget.RemoteViews r0 = r6.applyStandardTemplate(r1, r0, r2)
                int r3 = androidx.core.C0144R.C0146id.actions
                r0.removeAllViews(r3)
                if (r8 == 0) goto L_0x003d
                androidx.core.app.NotificationCompat$Builder r8 = r6.mBuilder
                java.util.ArrayList<androidx.core.app.NotificationCompat$Action> r8 = r8.mActions
                if (r8 == 0) goto L_0x003d
                androidx.core.app.NotificationCompat$Builder r8 = r6.mBuilder
                java.util.ArrayList<androidx.core.app.NotificationCompat$Action> r8 = r8.mActions
                int r8 = r8.size()
            ...
            L_0x0025:
                ...
                int r5 = androidx.core.C0144R.C0146id.actions
                r0.addView(r5, r4)
                int r3 = r3 + 1
                goto L_0x0025
            L_0x003d:
            ...
            L_0x0041:
                r2 = 8
            L_0x0043:
                int r8 = androidx.core.C0144R.C0146id.actions
                r0.setViewVisibility(r8, r2)
                int r8 = androidx.core.C0144R.C0146id.action_divider
                r0.setViewVisibility(r8, r2)
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0144R.layout.notification_action_tombstone : C0144R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0144R.C0146id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0144R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0144R.C0146id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0144R.C0146id.action_container, action.actionIntent);
            }
            if (VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0144R.C0146id.action_container, action.title);
            }
            return remoteViews;
        }
    }
                ...
                try {
                    if (bundle.containsKey("text")) {
                        if (bundle.containsKey(KEY_TIMESTAMP)) {
                            Person person = bundle.containsKey(KEY_PERSON) ? Person.fromBundle(bundle.getBundle(KEY_PERSON)) : (!bundle.containsKey(KEY_NOTIFICATION_PERSON) || VERSION.SDK_INT < 28) ? bundle.containsKey("sender") ? new androidx.core.app.Person.Builder().setName(bundle.getCharSequence("sender")).build() : null : Person.fromAndroidPerson((Person) bundle.getParcelable(KEY_NOTIFICATION_PERSON));
            ...
            if (VERSION.SDK_INT >= 24) {
                ...
                for (Message message2 : this.mMessages) {
                    if (VERSION.SDK_INT >= 28) {
                        ...
                        message = new android.app.Notification.MessagingStyle.Message(text, timestamp, person);
                    } else {
            ...
            if (VERSION.SDK_INT >= 16) {
                ...
                for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                    ...
                    if (size != this.mMessages.size() - 1) {
                        spannableStringBuilder.insert(0, FontStyleHelper.SPLITOR);
                    }
    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r13, int r14, boolean r15) {
            ...
            L_0x0023:
                ...
                int r14 = androidx.core.C0144R.C0146id.notification_background
                java.lang.String r2 = "setBackgroundResource"
                int r4 = androidx.core.C0144R.C0145drawable.notification_bg_low
                r7.setInt(r14, r2, r4)
                int r14 = androidx.core.C0144R.C0146id.icon
                java.lang.String r2 = "setBackgroundResource"
                int r4 = androidx.core.C0144R.C0145drawable.notification_template_icon_low_bg
                r7.setInt(r14, r2, r4)
                goto L_0x0056
            L_0x0044:
                int r14 = androidx.core.C0144R.C0146id.notification_background
                java.lang.String r2 = "setBackgroundResource"
                int r4 = androidx.core.C0144R.C0145drawable.notification_bg
                r7.setInt(r14, r2, r4)
                int r14 = androidx.core.C0144R.C0146id.icon
                java.lang.String r2 = "setBackgroundResource"
                int r4 = androidx.core.C0144R.C0145drawable.notification_template_icon_bg
                r7.setInt(r14, r2, r4)
            L_0x0056:
                androidx.core.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x0076:
                ...
                int r13 = r13.icon
                if (r13 == 0) goto L_0x010a
                int r13 = androidx.core.C0144R.dimen.notification_right_icon_size
                int r13 = r0.getDimensionPixelSize(r13)
                int r14 = androidx.core.C0144R.dimen.notification_small_icon_background_padding
                ...
                int r14 = androidx.core.C0144R.C0146id.right_icon
                r7.setImageViewBitmap(r14, r13)
                goto L_0x00b9
            L_0x00aa:
                int r13 = androidx.core.C0144R.C0146id.right_icon
                androidx.core.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x00bf:
                ...
                int r13 = r13.icon
                if (r13 == 0) goto L_0x010a
                int r13 = androidx.core.C0144R.C0146id.icon
                r7.setViewVisibility(r13, r9)
                int r13 = android.os.Build.VERSION.SDK_INT
                if (r13 < r3) goto L_0x00fb
                int r13 = androidx.core.C0144R.dimen.notification_large_icon_width
                int r13 = r0.getDimensionPixelSize(r13)
                int r14 = androidx.core.C0144R.dimen.notification_big_circle_margin
                int r14 = r0.getDimensionPixelSize(r14)
                int r13 = r13 - r14
                int r14 = androidx.core.C0144R.dimen.notification_small_icon_size_as_large
                int r14 = r0.getDimensionPixelSize(r14)
                androidx.core.app.NotificationCompat$Builder r1 = r12.mBuilder
                android.app.Notification r1 = r1.mNotification
                int r1 = r1.icon
            ...
            L_0x010a:
                ...
                int r13 = androidx.core.C0144R.C0146id.title
                androidx.core.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x0119:
                ...
                int r13 = androidx.core.C0144R.C0146id.text
                androidx.core.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x0138:
                ...
                int r13 = androidx.core.C0144R.C0146id.info
                androidx.core.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x014f:
                ...
                int r13 = androidx.core.C0144R.integer.status_bar_notification_info_maxnum
                int r13 = r0.getInteger(r13)
                androidx.core.app.NotificationCompat$Builder r14 = r12.mBuilder
                int r14 = r14.mNumber
                if (r14 <= r13) goto L_0x016d
                int r13 = androidx.core.C0144R.C0146id.info
                int r14 = androidx.core.C0144R.string.status_bar_notification_info_overflow
                java.lang.String r14 = r0.getString(r14)
                r7.setTextViewText(r13, r14)
                goto L_0x017f
            L_0x016d:
                java.text.NumberFormat r13 = java.text.NumberFormat.getIntegerInstance()
                int r14 = androidx.core.C0144R.C0146id.info
                androidx.core.app.NotificationCompat$Builder r1 = r12.mBuilder
                int r1 = r1.mNumber
                long r1 = (long) r1
            ...
            L_0x017f:
                ...
                goto L_0x018c
            L_0x0187:
                int r1 = androidx.core.C0144R.C0146id.info
            ...
            L_0x018c:
                ...
                int r1 = androidx.core.C0144R.C0146id.text
                androidx.core.app.NotificationCompat$Builder r2 = r12.mBuilder
                ...
                int r1 = androidx.core.C0144R.C0146id.text2
                androidx.core.app.NotificationCompat$Builder r2 = r12.mBuilder
            ...
            L_0x01bb:
                ...
                int r1 = android.os.Build.VERSION.SDK_INT
                if (r1 < r10) goto L_0x01d9
                if (r15 == 0) goto L_0x01cf
                int r15 = androidx.core.C0144R.dimen.notification_subtext_size
                int r15 = r0.getDimensionPixelSize(r15)
                float r15 = (float) r15
                int r0 = androidx.core.C0144R.C0146id.text
                r7.setTextViewTextSize(r0, r9, r15)
            L_0x01cf:
                int r2 = androidx.core.C0144R.C0146id.line1
                r3 = 0
                r4 = 0
                r5 = 0
                r6 = 0
            ...
            L_0x01d9:
                ...
                int r14 = androidx.core.C0144R.C0146id.chronometer
                r7.setViewVisibility(r14, r9)
                int r14 = androidx.core.C0144R.C0146id.chronometer
                ...
                goto L_0x0225
            L_0x0213:
                int r14 = androidx.core.C0144R.C0146id.time
                r7.setViewVisibility(r14, r9)
                int r14 = androidx.core.C0144R.C0146id.time
            ...
            L_0x0225:
                r14 = 1
            L_0x0226:
                int r15 = androidx.core.C0144R.C0146id.right_side
            ...
            L_0x022e:
                ...
                int r14 = androidx.core.C0144R.C0146id.line3
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0144R.C0145drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0144R.C0146id.notification_main_column);
            remoteViews.addView(C0144R.C0146id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0144R.C0146id.notification_main_column, 0);
            if (VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0144R.C0146id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0144R.C0146id.title, 8);
            remoteViews.setViewVisibility(C0144R.C0146id.text2, 8);
            remoteViews.setViewVisibility(C0144R.C0146id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0144R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0144R.dimen.notification_top_pad_large_text);
    ...
    public static final class WearableExtender implements Extender {
        ...
        public Builder extend(Builder builder) {
            ...
            if (str3 != null) {
                bundle.putString(KEY_BRIDGE_TAG, str3);
            }
            builder.getExtras().putBundle(EXTRA_WEARABLE_EXTENSIONS, bundle);
            return builder;
        }
    ...
    static Action getActionCompatFromAction(android.app.Notification.Action action) {
        ...
        Action action2 = new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, null, z, i, z2);
        return action2;
    }
