...
public class AppLaunchChecker {
    ...
    public static void onActivityCreate(@NonNull Activity activity) {
        ...
        if (!sharedPreferences.getBoolean(KEY_STARTED_FROM_LAUNCHER, false)) {
            ...
            if (intent != null && "android.intent.action.MAIN".equals(intent.getAction()) && (intent.hasCategory("android.intent.category.LAUNCHER") || intent.hasCategory(IntentCompat.CATEGORY_LEANBACK_LAUNCHER))) {
