...
public final class LinkifyCompat {
    ...
    public static boolean addLinks(@NonNull Spannable spannable, int i) {
        ...
        if ((i & 1) != 0) {
            gatherLinks(arrayList, spannable, PatternsCompat.AUTOLINK_WEB_URL, new String[]{ZMDomainUtil.ZM_URL_HTTP, "https://", "rtsp://"}, Linkify.sUrlMatchFilter, null);
        }
        if ((i & 2) != 0) {
    ...
    private static void gatherMapLinks(java.util.ArrayList<androidx.core.text.util.LinkifyCompat.LinkSpec> r5, android.text.Spannable r6) {
        ...
        L_0x0005:
            ...
            goto L_0x0043
        L_0x0012:
            androidx.core.text.util.LinkifyCompat$LinkSpec r3 = new androidx.core.text.util.LinkifyCompat$LinkSpec     // Catch:{ UnsupportedOperationException -> 0x0044 }
    ...
    private static void pruneOverlaps(ArrayList<LinkSpec> arrayList, Spannable spannable) {
        ...
        while (i < size - 1) {
            ...
            if (linkSpec2.start <= linkSpec3.start && linkSpec2.end > linkSpec3.start) {
                int i4 = linkSpec3.end <= linkSpec2.end ? i3 : linkSpec2.end - linkSpec2.start > linkSpec3.end - linkSpec3.start ? i3 : linkSpec2.end - linkSpec2.start < linkSpec3.end - linkSpec3.start ? i : -1;
                if (i4 != -1) {
