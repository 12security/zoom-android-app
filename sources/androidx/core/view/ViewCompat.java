...
public class ViewCompat {
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager m4at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0144R.C0146id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager != null) {
                return unhandledKeyEventManager;
            }
            UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
            view.setTag(C0144R.C0146id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
        ...
        private boolean onUnhandledKeyEvent(@NonNull View view, @NonNull KeyEvent keyEvent) {
            ArrayList arrayList = (ArrayList) view.getTag(C0144R.C0146id.tag_unhandled_key_listeners);
            if (arrayList != null) {
    ...
    public static void setPaddingRelative(@NonNull View view, @C0031Px int i, @C0031Px int i2, @C0031Px int i3, @C0031Px int i4) {
        if (VERSION.SDK_INT >= 17) {
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = 0.0d, mo581to = 1.0d) float f) {
        view.setAlpha(f);
    }
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (VERSION.SDK_INT >= 28) {
            Map map = (Map) view.getTag(C0144R.C0146id.tag_unhandled_key_listeners);
            if (map == null) {
                map = new ArrayMap();
                view.setTag(C0144R.C0146id.tag_unhandled_key_listeners, map);
            }
        ...
        if (arrayList == null) {
            ...
            view.setTag(C0144R.C0146id.tag_unhandled_key_listeners, arrayList);
        }
