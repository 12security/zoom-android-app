    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (parentMatches(viewGroup2, viewGroup3)) {
            ...
            if (i > 0) {
                ...
                if (!this.mResizeClip) {
                    ...
                    if (i == 2) {
                        ...
                        animator2 = ObjectAnimatorUtils.ofPointF(view, BOTTOM_RIGHT_ONLY_PROPERTY, getPathMotion().getPath((float) i7, (float) i9, (float) i8, (float) i10));
                    } else {
                        animator2 = ObjectAnimatorUtils.ofPointF(view, TOP_LEFT_ONLY_PROPERTY, getPathMotion().getPath((float) i3, (float) i5, (float) i4, (float) i6));
                    }
                } else {
                    view = view3;
                    ...
                    if (i3 == i4 && i5 == i6) {
                        ...
                        animator3 = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath((float) i3, (float) i5, (float) i4, (float) i6));
                    }
                    if (rect7 == null) {
                        i2 = 0;
                    ...
                    if (!rect.equals(rect8)) {
                        ...
                        final int i17 = i8;
                        final int i18 = i10;
                        C03808 r0 = new AnimatorListenerAdapter() {
                    ...
                    animator2 = TransitionUtils.mergeAnimators(animator3, objectAnimator);
                }
            ...
            if (intValue == intValue3 && intValue2 == intValue4) {
                ...
                C037310 r02 = new AnimatorListenerAdapter() {
                    public void onAnimationEnd(Animator animator) {
