...
public class ChangeImageTransform extends Transition {
    ...
    static /* synthetic */ class C03853 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.transition.ChangeImageTransform.C03853.<clinit>():void");
        }
    }
    ...
    private static Matrix copyImageMatrix(ImageView imageView) {
        switch (C03853.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
            case 1:
