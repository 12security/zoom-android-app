...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = SupportMenuInflater.this.mContext.obtainStyledAttributes(attributeSet, C0032R.styleable.MenuItem);
            ...
            this.itemActionProviderClassName = obtainStyledAttributes.getString(C0032R.styleable.MenuItem_actionProviderClass);
