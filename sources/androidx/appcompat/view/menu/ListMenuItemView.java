...
public class ListMenuItemView extends LinearLayout implements ItemView, SelectionBoundsAdjuster {
    ...
    public void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0032R.C0034id.title);
        ...
        this.mSubMenuArrowView = (ImageView) findViewById(C0032R.C0034id.submenuarrow);
    ...
    private void insertIconView() {
        this.mIconView = (ImageView) getInflater().inflate(C0032R.layout.abc_list_menu_item_icon, this, false);
        addContentView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        this.mRadioButton = (RadioButton) getInflater().inflate(C0032R.layout.abc_list_menu_item_radio, this, false);
        addContentView(this.mRadioButton);
    }

    private void insertCheckBox() {
        this.mCheckBox = (CheckBox) getInflater().inflate(C0032R.layout.abc_list_menu_item_checkbox, this, false);
