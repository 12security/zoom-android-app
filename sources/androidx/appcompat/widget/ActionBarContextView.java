...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mCloseItemLayout = obtainStyledAttributes.getResourceId(C0032R.styleable.ActionMode_closeItemLayout, C0032R.layout.abc_action_mode_close_item_material);
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0032R.C0034id.action_bar_title);
    ...
    public void initForMode(final ActionMode actionMode) {
        ...
        this.mClose.findViewById(C0032R.C0034id.action_mode_close_button).setOnClickListener(new OnClickListener() {
