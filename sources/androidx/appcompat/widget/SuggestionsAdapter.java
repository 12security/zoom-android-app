...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0032R.attr.textColorSearchUrl, typedValue, true);
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i) {
        ...
        if (i > 0) {
            fragment.appendQueryParameter(BoxList.FIELD_LIMIT, String.valueOf(i));
        }
