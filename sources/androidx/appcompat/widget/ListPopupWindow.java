...
public class ListPopupWindow implements ShowableListMenu {
    ...
    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        ...
        this.mDropDownVerticalOffset = obtainStyledAttributes.getDimensionPixelOffset(C0032R.styleable.ListPopupWindow_android_dropDownVerticalOffset, 0);
    ...
    private int buildDropDown() {
        ...
        switch (i6) {
            case -2:
                i3 = MeasureSpec.makeMeasureSpec(this.mContext.getResources().getDisplayMetrics().widthPixels - (this.mTempRect.left + this.mTempRect.right), Integer.MIN_VALUE);
                break;
            case -1:
                i3 = MeasureSpec.makeMeasureSpec(this.mContext.getResources().getDisplayMetrics().widthPixels - (this.mTempRect.left + this.mTempRect.right), Ints.MAX_POWER_OF_TWO);
                break;
            default:
                i3 = MeasureSpec.makeMeasureSpec(i6, Ints.MAX_POWER_OF_TWO);
                break;
        }
