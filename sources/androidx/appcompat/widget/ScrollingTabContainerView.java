...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayout {
        ...
        public TabView(Context context, Tab tab, boolean z) {
            super(context, null, C0032R.attr.actionBarTabStyle);
            this.mTab = tab;
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0032R.attr.actionBarTabStyle, 0);
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (ScrollingTabContainerView.this.mMaxTabWidth > 0 && getMeasuredWidth() > ScrollingTabContainerView.this.mMaxTabWidth) {
                super.onMeasure(MeasureSpec.makeMeasureSpec(ScrollingTabContainerView.this.mMaxTabWidth, Ints.MAX_POWER_OF_TWO), i2);
            }
        }
        ...
        public void update() {
            ...
            if (z) {
                if (this.mTextView == null) {
                    AppCompatTextView appCompatTextView = new AppCompatTextView(getContext(), null, C0032R.attr.actionBarTabTextStyle);
    ...
    public void onMeasure(int i, int i2) {
        ...
        int makeMeasureSpec = MeasureSpec.makeMeasureSpec(this.mContentHeight, Ints.MAX_POWER_OF_TWO);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0032R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        AppCompatSpinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0032R.attr.actionDropDownStyle);
