...
class AppCompatDelegateImpl extends AppCompatDelegate implements Callback, Factory2 {
    ...
    protected static final class PanelFeatureState {
        ...
        public void setStyle(Context context) {
            ...
            if (typedValue.resourceId != 0) {
                ...
                newTheme.applyStyle(C0032R.style.Theme_AppCompat_CompactMenu, true);
            }
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0032R.layout.abc_list_menu_item_layout);
        ...
        if (obtainStyledAttributes.hasValue(C0032R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    viewGroup = (ViewGroup) from.inflate(C0032R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    viewGroup = (ViewGroup) from.inflate(C0032R.layout.abc_screen_simple, null);
                }
                ...
                viewGroup = (ViewGroup) from.inflate(C0032R.layout.abc_dialog_title_material, null);
                ...
                viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C0032R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) viewGroup.findViewById(C0032R.C0034id.decor_content_parent);
    ...
    public androidx.appcompat.view.ActionMode startSupportActionModeFromWindow(@androidx.annotation.NonNull androidx.appcompat.view.ActionMode.Callback r8) {
        ...
        L_0x0029:
            ...
            int r5 = androidx.appcompat.C0032R.attr.actionBarTheme
        ...
        L_0x006a:
            ...
            int r6 = androidx.appcompat.C0032R.attr.actionModePopupWindowStyle
            r5.<init>(r4, r1, r6)
            ...
            int r6 = androidx.appcompat.C0032R.attr.actionBarSize
        ...
        L_0x00b7:
            ...
            int r4 = androidx.appcompat.C0032R.C0034id.action_mode_bar_stub
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108) && this.mDecorContentParent != null) {
            ...
            theme.resolveAttribute(C0032R.attr.actionBarTheme, typedValue, true);
            Theme theme2 = null;
            if (typedValue.resourceId != 0) {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i : 0)) {
                    ...
                    if (view == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0032R.color.abc_input_method_navigation_guard));
