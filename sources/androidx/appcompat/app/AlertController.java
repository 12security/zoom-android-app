...
class AlertController {
    ...
    public static class AlertParams {
        ...
        /* JADX WARNING: type inference failed for: r9v2, types: [androidx.appcompat.app.AlertController$CheckedItemAdapter] */
        /* JADX WARNING: type inference failed for: r2v3, types: [android.widget.SimpleCursorAdapter] */
        /* JADX WARNING: type inference failed for: r1v16, types: [androidx.appcompat.app.AlertController$AlertParams$2] */
        /* JADX WARNING: type inference failed for: r1v17, types: [androidx.appcompat.app.AlertController$AlertParams$1] */
        /* JADX WARNING: type inference failed for: r9v6 */
        /* JADX WARNING: type inference failed for: r2v6, types: [android.widget.SimpleCursorAdapter] */
        /* JADX WARNING: type inference failed for: r1v18, types: [androidx.appcompat.app.AlertController$AlertParams$2] */
        /* JADX WARNING: type inference failed for: r1v19, types: [androidx.appcompat.app.AlertController$AlertParams$1] */
        /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r9v1, types: [android.widget.ListAdapter]
          assigns: [android.widget.ListAdapter, android.widget.SimpleCursorAdapter, androidx.appcompat.app.AlertController$AlertParams$2, androidx.appcompat.app.AlertController$AlertParams$1]
          uses: [?[int, boolean, OBJECT, ARRAY, byte, short, char], android.widget.ListAdapter, android.widget.SimpleCursorAdapter, androidx.appcompat.app.AlertController$AlertParams$2, androidx.appcompat.app.AlertController$AlertParams$1]
          mth insns count: 69
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C0032R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C0032R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0032R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0032R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0032R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0032R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0032R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0032R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C0032R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = obtainStyledAttributes.getDimensionPixelSize(C0032R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    private void setupView() {
        View findViewById = this.mWindow.findViewById(C0032R.C0034id.parentPanel);
        View findViewById2 = findViewById.findViewById(C0032R.C0034id.topPanel);
        View findViewById3 = findViewById.findViewById(C0032R.C0034id.contentPanel);
        View findViewById4 = findViewById.findViewById(C0032R.C0034id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById.findViewById(C0032R.C0034id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById5 = viewGroup.findViewById(C0032R.C0034id.topPanel);
        View findViewById6 = viewGroup.findViewById(C0032R.C0034id.contentPanel);
        View findViewById7 = viewGroup.findViewById(C0032R.C0034id.buttonPanel);
        ...
        if (!z3 && resolvePanel2 != null) {
            View findViewById8 = resolvePanel2.findViewById(C0032R.C0034id.textSpacerNoButtons);
        ...
        if (z2) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                view = resolvePanel.findViewById(C0032R.C0034id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else if (resolvePanel2 != null) {
            View findViewById9 = resolvePanel2.findViewById(C0032R.C0034id.textSpacerNoTitle);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0032R.C0034id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0032R.C0034id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0032R.C0034id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0032R.C0034id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0032R.C0034id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0032R.C0034id.scrollView);
