...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    public static androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat create(@androidx.annotation.NonNull android.content.Context r4, @androidx.annotation.DrawableRes int r5) {
        ...
        L_0x0045:
            ...
            androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat r4 = createFromXmlInner(r4, r1, r5, r0, r2)     // Catch:{ XmlPullParserException -> 0x0065, IOException -> 0x005c }
            return r4
        L_0x0054:
