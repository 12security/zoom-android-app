...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        if (min > 0) {
            this.f39mX = new float[min];
            this.f40mY = new float[min];
            ...
            if (((double) Math.abs(this.f39mX[0])) <= 1.0E-5d && ((double) Math.abs(this.f40mY[0])) <= 1.0E-5d) {
                int i3 = min - 1;
                if (((double) Math.abs(this.f39mX[i3] - 1.0f)) <= 1.0E-5d && ((double) Math.abs(this.f40mY[i3] - 1.0f)) <= 1.0E-5d) {
                    int i4 = 0;
                    float f = 0.0f;
                    while (i < min) {
            ...
            sb2.append(this.f39mX[0]);
            sb2.append(PreferencesConstants.COOKIE_DELIMITER);
            sb2.append(this.f40mY[0]);
            sb2.append(" end:");
            int i6 = min - 1;
            sb2.append(this.f39mX[i6]);
            sb2.append(PreferencesConstants.COOKIE_DELIMITER);
            sb2.append(this.f40mY[i6]);
