            ...
            if ((next != 3 || xmlPullParser.getDepth() > depth) && next != 1) {
                if (next == 2) {
                    ...
                    if (name.equals("objectAnimator")) {
                        ...
                        createAnimatorFromXml(context4, resources3, theme3, xmlPullParser3, attributeSet2, (AnimatorSet) animatorSet3, TypedArrayUtils.getNamedInt(obtainAttributes, xmlPullParser2, "ordering", 0, 0), f);
                        typedArray.recycle();
