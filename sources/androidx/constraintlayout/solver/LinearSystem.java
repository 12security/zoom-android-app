...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f12id == -1 || solverVariable.f12id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f12id] == null) {
                if (solverVariable.f12id != -1) {
                    solverVariable.reset();
                }
                this.mVariablesID++;
                this.mNumColumns++;
                solverVariable.f12id = this.mVariablesID;
    ...
    public SolverVariable createSlackVariable() {
        ...
        this.mVariablesID++;
        this.mNumColumns++;
        acquireSolverVariable.f12id = this.mVariablesID;
    ...
    private final int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f12id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f12id]) {
                    return i2;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f12id] = true;
            }
            if (pivotCandidate != null) {
                int i3 = -1;
    ...
    private void displayRows() {
        ...
        sb4.append(FontStyleHelper.SPLITOR);
