    ...
    public boolean isSnapCompatibleWith(ConstraintAnchor constraintAnchor) {
        ...
        switch (this.mType) {
            ...
            case NONE:
                return false;
            case LEFT:
                int i = C01331.f13x4c44d048[constraintAnchor.getType().ordinal()];
                if (i == 3 || i == 7) {
                    return true;
                }
                return false;
            case RIGHT:
                int i2 = C01331.f13x4c44d048[constraintAnchor.getType().ordinal()];
                if (i2 == 2 || i2 == 7) {
                    return true;
                }
                return false;
            case TOP:
                int i3 = C01331.f13x4c44d048[constraintAnchor.getType().ordinal()];
                if (i3 == 5 || i3 == 8) {
                    return true;
                }
                return false;
            case BOTTOM:
                int i4 = C01331.f13x4c44d048[constraintAnchor.getType().ordinal()];
                if (i4 == 4 || i4 == 8) {
                    return true;
                }
                return false;
