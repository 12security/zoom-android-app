...
public class Analyzer {
    ...
    private static int getMaxDimensionTraversal(ConstraintWidget constraintWidget, int i, boolean z, int i2) {
        ...
        boolean z3 = constraintWidget2.mBaseline.mTarget != null && i14 == 1;
        if (z2) {
        ...
        int i16 = (z3 ? i2 - i6 : i2) + margin;
        int width = (i14 == 0 ? constraintWidget.getWidth() : constraintWidget.getHeight()) * i8;
        Iterator it = constraintWidget2.mListAnchors[i4].getResolutionNode().dependents.iterator();
        while (it.hasNext()) {
            i15 = Math.max(i15, getMaxDimensionTraversal(((ResolutionAnchor) ((ResolutionNode) it.next())).myAnchor.mOwner, i14, z2, i16));
        }
        Iterator it2 = constraintWidget2.mListAnchors[i7].getResolutionNode().dependents.iterator();
        int i17 = 0;
        while (it2.hasNext()) {
            Iterator it3 = it2;
            i17 = Math.max(i17, getMaxDimensionTraversal(((ResolutionAnchor) ((ResolutionNode) it2.next())).myAnchor.mOwner, i14, z2, width + i16));
            it2 = it3;
        }
        if (z3) {
            i15 -= i6;
            ...
            i9 = i17 + ((i14 == 0 ? constraintWidget.getWidth() : constraintWidget.getHeight()) * i8);
            i10 = 1;
        }
        if (i14 == i10) {
            ...
            while (it4.hasNext()) {
                ...
                if (i8 == i10) {
                    i18 = Math.max(i18, getMaxDimensionTraversal(resolutionAnchor.myAnchor.mOwner, i14, z2, i6 + i16));
                    i13 = i7;
                } else {
                    i13 = i7;
                    i18 = Math.max(i18, getMaxDimensionTraversal(resolutionAnchor.myAnchor.mOwner, i14, z2, (i5 * i8) + i16));
                }
                it4 = it5;
                i7 = i13;
                i10 = 1;
            ...
            i11 = i7;
            int i19 = i18;
            i12 = (constraintWidget2.mBaseline.getResolutionNode().dependents.size() <= 0 || z3) ? i19 : i8 == 1 ? i19 + i6 : i19 - i5;
        } else {
            i11 = i7;
            i12 = 0;
        }
        int max = margin + Math.max(i15, Math.max(i9, i12));
        int i20 = i16 + width;
        if (i8 == -1) {
            int i21 = i16;
            i16 = i20;
        ...
        if (z2) {
            Optimizer.setOptimizedWidget(constraintWidget2, i14, i16);
            constraintWidget2.setFrame(i16, i20, i14);
        } else {
            constraintWidget2.mBelongingGroup.addWidgetsToSet(constraintWidget2, i14);
            constraintWidget2.setRelativePositioning(i16, i14);
        }
        if (constraintWidget.getDimensionBehaviour(i) == DimensionBehaviour.MATCH_CONSTRAINT && constraintWidget2.mDimensionRatio != 0.0f) {
            constraintWidget2.mBelongingGroup.addWidgetsToSet(constraintWidget2, i14);
        }
        if (!(constraintWidget2.mListAnchors[i4].mTarget == null || constraintWidget2.mListAnchors[i11].mTarget == null)) {
            ConstraintWidget parent = constraintWidget.getParent();
            if (constraintWidget2.mListAnchors[i4].mTarget.mOwner == parent && constraintWidget2.mListAnchors[i11].mTarget.mOwner == parent) {
                constraintWidget2.mBelongingGroup.addWidgetsToSet(constraintWidget2, i14);
            }
        }
        return max;
