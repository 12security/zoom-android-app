...
class FragmentTransition {
    ...
    public static void calculateFragments(BackStackRecord backStackRecord, SparseArray<FragmentContainerTransition> sparseArray, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            addToFirstInLastOut(backStackRecord, (C0208Op) backStackRecord.mOps.get(i), sparseArray, false, z);
        }
    }
    ...
    public static void calculatePopFragments(BackStackRecord backStackRecord, SparseArray<FragmentContainerTransition> sparseArray, boolean z) {
        if (backStackRecord.mManager.mContainer.onHasView()) {
            for (int size = backStackRecord.mOps.size() - 1; size >= 0; size--) {
                addToFirstInLastOut(backStackRecord, (C0208Op) backStackRecord.mOps.get(size), sparseArray, true, z);
            }
        }
    }
    ...
    private static void addToFirstInLastOut(BackStackRecord backStackRecord, C0208Op op, SparseArray<FragmentContainerTransition> sparseArray, boolean z, boolean z2) {
        boolean z3;
        boolean z4;
        boolean z5;
        ...
        if (fragment != null) {
            ...
            if (i != 0) {
                int i2 = z6 ? INVERSE_OPS[op2.cmd] : op2.cmd;
                boolean z7 = false;
                if (i2 != 1) {
                    switch (i2) {
                        case 3:
                ...
                boolean z11 = z2 ? fragment.mIsNewlyAdded : !fragment.mAdded && !fragment.mHidden;
                z7 = z11;
                z5 = true;
                z4 = false;
                z3 = false;
                ...
                if (z7) {
                    ...
                    ensureContainer.lastInIsPop = z6;
                ...
                if (z3 && (fragmentContainerTransition == null || fragmentContainerTransition.firstOut == null)) {
                    ...
                    fragmentContainerTransition.firstOutIsPop = z6;
