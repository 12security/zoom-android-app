...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
        ...
        if (str == null) {
            ...
            while (i < i2) {
                ...
                if (charAt < 128) {
                    ...
                    writeByte((charAt >> 12) | DummyPolicyIDType.zPolicy_SetShortCuts_JumpToSession);
                    ...
                    if (charAt > 56319 || c < 56320 || c > 57343) {
                        ...
                        writeByte((i8 >> 18) | DummyPolicyIDType.zPolicy_EnableElevateForAdvDSCP);
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            if (i < 55296 || i > 57343) {
                writeByte((i >> 12) | DummyPolicyIDType.zPolicy_SetShortCuts_JumpToSession);
            ...
            writeByte((i >> 18) | DummyPolicyIDType.zPolicy_EnableElevateForAdvDSCP);
    ...
    public long indexOf(byte b, long j, long j2) {
        ...
        while (j6 < j5) {
            byte[] bArr = segment.data;
            int min = (int) Math.min((long) segment.limit, (((long) segment.pos) + j5) - j6);
            for (int i = (int) ((((long) segment.pos) + j3) - j6); i < min; i++) {
                if (bArr[i] == b) {
        ...
        if (j >= 0) {
            ...
            if (byteString.size() == 2) {
                ...
                while (j3 < this.size) {
                    ...
                    for (int i4 = (int) ((((long) segment.pos) + j) - j3); i4 < i3; i4++) {
                        byte b4 = bArr2[i4];
                        for (byte b5 : internalArray) {
                            if (b4 == b5) {
                                return ((long) (i4 - segment.pos)) + j3;
                            }
                        }
                    }
                    j = ((long) (segment.limit - segment.pos)) + j3;
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m271of(instance.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m271of(instance.doFinal());
        } catch (NoSuchAlgorithmException unused) {
            throw new AssertionError();
