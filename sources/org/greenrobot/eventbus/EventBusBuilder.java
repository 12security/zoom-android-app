...
public class EventBusBuilder {
    ...
    public MainThreadSupport getMainThreadSupport() {
        ...
        AndroidHandlerMainThreadSupport androidHandlerMainThreadSupport = null;
        ...
        if (androidMainLooperOrNull != null) {
            androidHandlerMainThreadSupport = new AndroidHandlerMainThreadSupport((Looper) androidMainLooperOrNull);
        }
