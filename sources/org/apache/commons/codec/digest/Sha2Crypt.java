...
public class Sha2Crypt {
    ...
    private static String sha2Crypt(byte[] bArr, String str, String str2, int i, String str3) {
        ...
        if (str4 != null) {
            ...
            for (int i6 = 1; i6 <= (digest4[0] & UnsignedBytes.MAX_VALUE) + Ascii.DLE; i6++) {
            ...
            if (i3 == 32) {
                ...
                B64.b64from24bit(0, digest4[31], digest4[30], 3, sb2);
                b = 0;
            } else {
                ...
                b = 0;
                B64.b64from24bit(0, 0, digest4[63], 2, sb2);
            }
