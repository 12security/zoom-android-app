...
public class ResponseContentEncoding implements HttpResponseInterceptor {
    ...
    public ResponseContentEncoding(Lookup<InputStreamFactory> lookup, boolean z) {
        if (lookup == null) {
            lookup = RegistryBuilder.create().register("gzip", GZIPInputStreamFactory.getInstance()).register("x-gzip", GZIPInputStreamFactory.getInstance()).register("deflate", DeflateInputStreamFactory.getInstance()).build();
        }
