...
public class ProxySelectorRoutePlanner implements HttpRoutePlanner {
    ...
    static /* synthetic */ class C43891 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.apache.http.impl.conn.ProxySelectorRoutePlanner.C43891.<clinit>():void");
        }
    }
    ...
    public Proxy chooseProxy(List<Proxy> list, HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) {
        ...
        while (proxy == null && i < list.size()) {
            ...
            switch (C43891.$SwitchMap$java$net$Proxy$Type[proxy2.type().ordinal()]) {
                case 1:
                case 2:
                    proxy = proxy2;
                    break;
