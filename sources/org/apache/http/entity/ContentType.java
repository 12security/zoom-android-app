...
public final class ContentType implements Serializable {
    ...
    public static final ContentType APPLICATION_JSON = create(WebRequestHandler.HEADER_ACCEPT_JSON, Consts.UTF_8);
    ...
    public static final ContentType IMAGE_GIF = create(AndroidAppUtil.IMAGE_MIME_TYPE_GIF);
    public static final ContentType IMAGE_JPEG = create(AndroidAppUtil.IMAGE_MIME_TYPE_JPG);
    public static final ContentType IMAGE_PNG = create(AndroidAppUtil.IMAGE_MIME_TYPE_PNG);
