...
//	void startConfUI();
	...
	boolean presentToRoom(int action, String paringCode, long meetNumber, boolean checkAudioDevice);
	void stopPresentToRoom(boolean showPresentToRoomCancelStatus);
	boolean isAuthenticating();
	void setNeedCheckSwitchCall(boolean needCheckSwitchCall);
	void logout();
	void notifyLeaveAndPerformAction(int action, int value, int extraValue);
